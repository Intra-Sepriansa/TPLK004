...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'attendance.location.sample_count' => 'integer',
            'attendance.location.sample_window_seconds' => 'integer',
            'attendance.location.sample_max_age_seconds' => 'integer',
            'attendance.location.max_speed_mps' => 'double',
            'attendance.location.max_jump_m' => 'double',
            'attendance.location.max_spread_m' => 'double',
            'attendance.ip_geolocation.enabled' => 'boolean',
            'attendance.ip_geolocation.url' => 'string',
            'attendance.ip_geolocation.max_distance_m' => 'double',
            'attendance.ai.service_url' => 'string',
            'attendance.ai.api_key' => 'string',
            'attendance.ai.min_conf' => 'double',
            'attendance.ai.target_label' => 'string',
            'attendance.ai.maintenance' => 'boolean',
            'auth.defaults.guard' => 'string',
            'auth.defaults.passwords' => 'string',
            'auth.guards.web.driver' => 'string',
            'auth.guards.web.provider' => 'string',
            'auth.guards.mahasiswa.driver' => 'string',
            'auth.guards.mahasiswa.provider' => 'string',
            ...
            'auth.providers.mahasiswa.driver' => 'string',
            'auth.providers.mahasiswa.model' => 'string',
            ...
            'cache.prefix' => 'string',
            'credentials.seed.admin_email' => 'string',
            'credentials.seed.admin_password' => 'string',
            'credentials.seed.dosen_password' => 'string',
            'credentials.mahasiswa.default_password_mode' => 'string',
            'credentials.mahasiswa.default_password_prefix' => 'string',
            'credentials.mahasiswa.default_password_fixed' => 'string',
            'credentials.mahasiswa.import_password_mode' => 'string',
            'credentials.mahasiswa.import_password_prefix' => 'string',
            'credentials.mahasiswa.import_password_fixed' => 'string',
            ...
            'filesystems.links./Users/intrasepriansa/Herd/TPLK004/public/storage' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.display_timezone','attendance.location.sample_count','attendance.location.sample_window_seconds',
'attendance.location.sample_max_age_seconds','attendance.location.max_speed_mps','attendance.location.max_jump_m','attendance.location.max_spread_m','attendance.ip_geolocation.enabled',
'attendance.ip_geolocation.url','attendance.ip_geolocation.max_distance_m','attendance.ai.service_url','attendance.ai.api_key','attendance.ai.min_conf',
'attendance.ai.target_label','attendance.ai.maintenance','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
'auth.guards.web.provider','auth.guards.mahasiswa.driver','auth.guards.mahasiswa.provider','auth.guards.dosen.driver','auth.guards.dosen.provider',
'auth.providers.users.driver','auth.providers.users.model','auth.providers.mahasiswa.driver','auth.providers.mahasiswa.model','auth.providers.dosen.driver',
'auth.providers.dosen.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle',
...
'cache.stores.octane.driver','cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','credentials.seed.admin_email',
'credentials.seed.admin_password','credentials.seed.dosen_password','credentials.mahasiswa.default_password_mode','credentials.mahasiswa.default_password_prefix','credentials.mahasiswa.default_password_fixed',
'credentials.mahasiswa.import_password_mode','credentials.mahasiswa.import_password_prefix','credentials.mahasiswa.import_password_fixed','database.default','database.connections.sqlite.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/intrasepriansa/Herd/TPLK004/public/storage','fortify.guard',
...
'reverb.apps.apps.0.ping_interval','reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_message_size','services.postmark.key','services.resend.key',
...
'two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','api.settings.index','api.settings.update',
'api.settings.category','settings.reset','api.settings.export','settings.import','api.settings.defaults',
'api.settings.sessions','api.settings.sessions.terminate','api.settings.login-history','api.settings.storage','settings.clear-cache',
'api.docs.index','api.docs.search','api.docs.show','api.docs.progress','api.docs.progress.guide',
'api.docs.progress.update','api.docs.progress.put','api.docs.progress.complete','api.docs.progress.reset','api.docs.stats',
'api.docs.bookmarks.index','api.docs.bookmarks.toggle','api.docs.feedback.show','api.docs.feedback.upsert','api.docs.offline.index',
'api.docs.offline.upsert','api.docs.offline.remove','api.tutorials.index','api.tutorials.status','api.tutorials.show',
'api.tutorials.should-show','api.tutorials.start','api.tutorials.advance','api.tutorials.step','api.tutorials.complete',
'api.tutorials.skip','api.tutorials.reset','api.help.faqs','api.help.faqs.rate','api.help.faqs.category',
'api.help.search','api.help.troubleshooting','api.help.videos','api.help.analytics.page-view','api.help.analytics.search',
'api.help.analytics.view','api.help.analytics.summary','api.help.contact','api.help.feedback','api.dosen.settings.index',
'api.dosen.settings.general','api.dosen.settings.teaching','api.dosen.settings.class-management','api.dosen.settings.notifications','api.dosen.settings.privacy',
'api.dosen.settings.password','api.dosen.settings.reset','api.dosen.settings.export','api.dosen.settings.export-pdf','api.attendance.ai-status',
'api.kas.analytics.health-score','api.kas.analytics.predictions','api.kas.analytics.insights','api.kas.reminders.preferences','api.kas.reminders.snooze',
'api.kas.achievements','api.kas.leaderboard','api.kas.challenges','api.kas.receipts.upload','api.kas.export',
'api.kas.reports.generate','home','privacy','dashboard',
'analytics','admin.profile','admin.profile.update','admin.profile.avatar','admin.profile.password',
'courses.store','attendance-sessions.store','attendance-sessions.update','attendance-sessions.destroy','attendance-sessions.activate',
'attendance-sessions.close','attendance-sessions.token','attendance-logs.index','attendance-ai.scan','selfie-verifications.approve',
'selfie-verifications.reject','selfie-view-requests.store','settings.update','settings.theme.update','settings.geofence',
'reports.export','reports.audit','admin.audit','admin.audit.show','admin.audit.action',
'admin.audit.pdf','admin.rekap-kehadiran','admin.rekap-kehadiran.pdf','admin.rekap-kehadiran.show','admin.attendance.warning.store',
'attendance-sessions.create','attendance-sessions.toggle','attendance-sessions.deactivate','admin.mahasiswa','admin.mahasiswa.create',
'admin.mahasiswa.check-duplicate','admin.mahasiswa.store','admin.mahasiswa.edit','admin.mahasiswa.show','admin.mahasiswa.update',
'admin.mahasiswa.destroy','admin.mahasiswa.reset-password','admin.mahasiswa.pdf','admin.jadwal','admin.jadwal.create',
'admin.jadwal.store','admin.jadwal.edit','admin.jadwal.update','admin.jadwal.destroy','admin.jadwal.activate',
'admin.jadwal.deactivate','admin.jadwal.pdf','admin.perangkat','admin.perangkat.pdf','admin.perangkat.show',
'admin.perangkat.export-detail-pdf','admin.perangkat.block','admin.perangkat.whitelist','admin.pengaturan','admin.pengaturan.update',
'admin.pengaturan.geofence','admin.pengaturan.notifications','admin.pengaturan.advanced','admin.pengaturan.backup','admin.pengaturan.backup.restore',
'admin.pengaturan.backup.delete','admin.pengaturan.export','admin.pengaturan.import','admin.pengaturan.history','admin.pengaturan.clear-cache',
'admin.pengaturan.optimize','admin.pengaturan.templates.update','admin.pengaturan.preferences.update','admin.qr-builder','admin.live-monitor',
'admin.live-monitor.refresh','admin.live-monitor.export-today','admin.live-monitor.logs','admin.live-monitor.aktivitas-terbaru','admin.live-monitor.aktivitas-terbaru.export',
'admin.live-monitor.aktivitas-terbaru.export-detail','admin.verifikasi-selfie','admin.verifikasi-selfie.show','admin.verifikasi-selfie.approve','admin.verifikasi-selfie.reject',
'admin.verifikasi-selfie.patch-approve','admin.verifikasi-selfie.patch-reject','admin.verifikasi-selfie.bulk-approve','admin.verifikasi-selfie.bulk-reject','admin.verifikasi-selfie.consume-view',
'admin.zona','admin.zona.update','admin.sesi-absen','admin.sesi-absen.create','admin.sesi-absen.edit',
'admin.sesi-absen.store','admin.sesi-absen.pdf','admin.sesi-absen.show','admin.sesi-absen.update','admin.sesi-absen.destroy',
'admin.sesi-absen.activate','admin.sesi-absen.deactivate','admin.sesi-absen.duplicate','admin.kas','admin.kas.store',
'admin.kas.destroy','admin.kas.mark-paid','admin.kas.expense','admin.kas.bulk-mark-paid','admin.kas.create-pertemuan',
'admin.kas.pdf','admin.kas-voting','admin.kas-voting.show','admin.kas-voting.approve','admin.kas-voting.reject',
'admin.kas-voting.close','admin.kas-voting.finalize','admin.leaderboard','admin.analytics','admin.analytics.export',
'admin.analytics.student.detail','admin.advanced-analytics','admin.notification-center.create','admin.notification-center.templates','admin.notification-center.bulk-delete',
'admin.notification-center.post-bulk-delete','admin.notification-center','admin.notification-center.store','admin.notification-center.show','admin.notification-center.resend',
'admin.notification-center.cancel','admin.notification-center.export','admin.notification-center.destroy','admin.weekly-digest.index','admin.weekly-digest.create',
'admin.weekly-digest.store','admin.weekly-digest.batch-export','admin.weekly-digest.show','admin.weekly-digest.edit','admin.weekly-digest.update',
'admin.weekly-digest.destroy','admin.weekly-digest.publish','admin.weekly-digest.export-pdf','admin.notifications.read','admin.notifications.read-all',
'admin.notifications.destroy','admin.panduan','admin.help-center','admin.tugas','admin.tugas.create',
'admin.tugas.store','admin.tugas.draft','admin.tugas.show','admin.tugas.update','admin.tugas.destroy',
'admin.tugas.message','admin.tugas.diskusi.pin','admin.tugas.diskusi.delete','admin.tugas-kelompok','admin.tugas-kelompok.create',
'admin.tugas-kelompok.workflow','admin.tugas-kelompok.store','admin.tugas-kelompok.show','admin.tugas-kelompok.destroy','admin.tugas-kelompok.random-groups',
'admin.tugas-kelompok.assign-student','admin.tugas-kelompok.create-group','admin.tugas-kelompok.toggle-lock','admin.tugas-kelompok.grade','admin.tugas-kelompok.resolve-conflict',
'admin.tugas-kelompok.export-pdf','mahasiswa.store','mahasiswa.export','mahasiswa.destroy','mahasiswa.login','mahasiswa.logout','dosen.login','user.dashboard','user.dashboard.alt',
'user.absen','user.absen.store','user.rekapan','user.bukti-masuk','user.history',
'user.history.export-pdf','user.history.detail','user.achievements','user.achievements.claim','user.badge-detail',
'user.leaderboard','user.kas','user.tugas','user.tugas.show','user.tugas.message',
'user.tugas-kelompok','user.tugas-kelompok.show','user.tugas-kelompok.export-pdf','user.tugas-kelompok.create-group','user.tugas-kelompok.join-group',
'user.tugas-kelompok.join-slot','user.tugas-kelompok.leader.add-member','user.tugas-kelompok.leader.remove-member','user.tugas-kelompok.leader.set-leader','user.tugas-kelompok.leave-group',
'user.tugas-kelompok.message','user.tugas-kelompok.upload','user.tugas-kelompok.task','user.tugas-kelompok.task-status','user.tugas-kelompok.submit',
'user.tugas-kelompok.peer-eval','user.tugas-kelompok.conflict','user.tugas-kelompok.invite','user.tugas-kelompok.invitation.respond','user.tugas-kelompok.rename-group',
'user.permit','user.permit.create','user.permit.attachment','user.permit.store','user.permit.comment',
'user.permit.destroy','user.kas-voting','user.kas-voting.create','user.kas-voting.detail','user.kas-voting.store',
'user.kas-voting.vote','user.tugas.submit','user.profile','user.profile.update','user.profile.avatar',
'user.password','user.password.update','user.akademik','user.akademik.jadwal','user.akademik.jadwal.reschedule',
'user.akademik.kehadiran','user.akademik.kehadiran.online-claim','user.akademik.kehadiran.show','user.akademik.ujian','user.akademik.ujian.detail',
'user.schedule.detail','user.schedule.reminder.toggle','user.schedule.export-ical','user.schedule.notes.store','user.schedule.notes.update',
'user.schedule.notes.delete','user.akademik.mata-kuliah','user.akademik.matkul','user.akademik.mata-kuliah.export','user.akademik.mata-kuliah.favorite',
'user.akademik.matkul.favorite','user.akademik.matkul.store','user.akademik.matkul.update','user.akademik.matkul.destroy','user.akademik.matkul.meeting.complete',
'user.akademik.catatan','user.akademik.catatan.create','user.akademik.catatan.store','user.akademik.catatan.show','user.akademik.catatan.export-pdf',
'user.akademik.catatan.edit','user.akademik.catatan.update','user.akademik.catatan.destroy','user.akademik.catatan.ai-process','user.akademik.catatan.generate-summary',
'user.akademik.catatan.generate-flashcards','user.personal-analytics','user.schedule','user.schedule.export-pdf','user.notifications',
'user.notifications.show','user.notifications.read','user.notifications.read-all','user.notifications.destroy','user.weekly-digest.show',
'user.weekly-digest.export-pdf','user.settings','user.docs','user.docs.detail','user.help',
'user.selfie-verification','user.selfie-view-requests.approve','user.selfie-view-requests.reject','profile.edit',
'profile.update','profile.avatar','profile.destroy','user-password.edit','user-password.update',
'appearance.edit','two-factor.show','theme.show','theme.update','dosen.logout',
'dosen.dashboard','dosen.dashboard.alt','dosen.sesi-absen','dosen.sesi-absen.create','dosen.sesi-absen.show',
'dosen.sesi-absen.export-pdf','dosen.sesi-absen.send-reminder','dosen.courses','dosen.courses.show','dosen.courses.export-pdf',
'dosen.courses.students','dosen.courses.student-detail','dosen.sessions.store','dosen.attendance-sessions.store.dosen','dosen.sessions.show',
'dosen.sessions.activate','dosen.sessions.close','dosen.sessions.regenerate-qr','dosen.attendance-sessions.activate.dosen','dosen.attendance-sessions.close.dosen',
'dosen.verify','dosen.verify.quick-verify','dosen.verify.ai-auto-verify','dosen.verify.export','dosen.verify.show',
'dosen.verify.approve','dosen.verify.reject','dosen.verify.scan-ai','dosen.rekapan','dosen.rekapan.pdf',
'dosen.rekapan.show','dosen.profile','dosen.profile.update','dosen.profile.avatar','dosen.profile.password',
'dosen.tugas','dosen.tugas.store','dosen.tugas.create','dosen.tugas.create.store','dosen.tugas.create.bulk-store',
'dosen.tugas.create.bulk-preview','dosen.tugas.create.bulk-import','dosen.tugas.create.bulk-template','dosen.tugas.create.upload','dosen.tugas.create.ai.suggest-title',
'dosen.tugas.create.ai.generate-description','dosen.tugas.create.ai.predict-deadline','dosen.tugas.create.templates.index','dosen.tugas.create.templates.store','dosen.tugas.create.templates.apply',
'dosen.tugas.create.templates.favorite','dosen.tugas.create.templates.destroy','dosen.tugas.show','dosen.tugas.update','dosen.tugas.destroy',
'dosen.tugas.message','dosen.tugas.diskusi.pin','dosen.tugas.diskusi.delete','dosen.tugas.grading','dosen.tugas.submission.grade',
'dosen.tugas.bulk-grade','dosen.permits','dosen.permits.show','dosen.permits.approve','dosen.permits.reject',
'dosen.permits.comment','dosen.permits.bulk-approve','dosen.grading','dosen.grading.export','dosen.grading.export-pdf',
'dosen.grading.student','dosen.grading.override','dosen.grading.detail','dosen.grading.detail.export','dosen.grading.detail.print',
'dosen.grading.detail.update-status','dosen.grading.detail.add-note','dosen.grading.detail.delete-note','dosen.class-insights','dosen.class-insights.export-csv',
'dosen.class-insights.export-pdf','dosen.class-insights.export-excel','dosen.class-insights.export-json','dosen.session-templates.create','dosen.session-templates.edit',
'dosen.session-templates.store-advanced','dosen.session-templates.update-advanced','dosen.session-templates.draft','dosen.session-templates','dosen.session-templates.store',
'dosen.session-templates.update','dosen.session-templates.destroy','dosen.session-templates.generate','dosen.session-templates.create-session','dosen.session-templates.duplicate',
'dosen.session-templates.toggle-active','dosen.notifications.create','dosen.notifications','dosen.notifications.store','dosen.notifications.read',
'dosen.notifications.read-all','dosen.notifications.destroy','dosen.settings','dosen.docs','dosen.docs.detail',
'dosen.help','dosen.','dosen.','dosen.','dosen.',
'dosen.','dosen.','dosen.','dosen.tugas-kelompok','dosen.tugas-kelompok.create',
'dosen.tugas-kelompok.store','dosen.tugas-kelompok.show','dosen.tugas-kelompok.destroy','dosen.tugas-kelompok.random-groups','dosen.tugas-kelompok.assign-student',
'dosen.tugas-kelompok.create-group','dosen.tugas-kelompok.toggle-lock','dosen.tugas-kelompok.grade','dosen.tugas-kelompok.resolve-conflict','dosen.tugas-kelompok.group-progress',
'chat.index','chat.contacts.search','chat.store','chat.course-group','chat.show','storage.local',);
        registerArgumentsSet('views', 
'app','dosen.reports.class-insights','errors.403','errors.404','errors.419',
'errors.500','errors.503','exports.notification-recipients','l5-swagger::index','pdf.academic-note-detail',
'pdf.admin-tugas-kelompok-detail','pdf.aktivitas-detail','pdf.aktivitas-terbaru','pdf.audit-keamanan','pdf.dosen-course-report',
'pdf.dosen-settings','pdf.grading-detail-report','pdf.jadwal','pdf.jadwal-kuliah','pdf.kas-matrix',
'pdf.kas-report','pdf.mahasiswa','pdf.nilai-kehadiran-dosen','pdf.perangkat','pdf.perangkat-detail',
'pdf.rekap-kehadiran-admin','pdf.rekap-kehadiran-matkul','pdf.rekapan-kehadiran','pdf.riwayat-kehadiran','pdf.selfie-verifications',
'pdf.sesi-absen','pdf.user-tugas-kelompok-detail','pdf.weekly-learning-digest','print.grading-detail','vendor.l5-swagger.index',
...
'validation.custom.attribute-name.rule-name','validation.attributes.name','validation.attributes.email','validation.attributes.password','validation.attributes.password_confirmation',
'validation.attributes.current_password','validation.attributes.title','validation.attributes.description','validation.attributes.content','validation.attributes.message',
'validation.attributes.course_id','validation.attributes.mata_kuliah_id','validation.attributes.category','validation.attributes.kategori','validation.attributes.priority',
'validation.attributes.prioritas','validation.attributes.deadline','validation.attributes.bobot_nilai','validation.attributes.estimated_hours','validation.attributes.schedule_type',
'validation.attributes.publish_at','validation.attributes.recurring_pattern','validation.attributes.collaboration_type','validation.attributes.collaboration_settings','validation.attributes.dependencies',
'validation.attributes.reminders','validation.attributes.attachments','validation.attributes.file','validation.attributes.image',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','LOCATION_SAMPLE_COUNT','LOCATION_SAMPLE_WINDOW_SECONDS',
'LOCATION_SAMPLE_MAX_AGE_SECONDS','LOCATION_MAX_SPEED_MPS','LOCATION_MAX_JUMP_M','LOCATION_MAX_SPREAD_M','IP_GEOLOCATION_ENABLED',
'IP_GEOLOCATION_URL','IP_GEOLOCATION_MAX_DISTANCE_M','YOLO_SERVICE_URL','YOLO_API_KEY','YOLO_MIN_CONF',
'YOLO_TARGET_LABEL','SEED_ADMIN_EMAIL','SEED_ADMIN_PASSWORD','SEED_DOSEN_PASSWORD','MAHASISWA_DEFAULT_PASSWORD_MODE',
'MAHASISWA_DEFAULT_PASSWORD_PREFIX','MAHASISWA_DEFAULT_PASSWORD_FIXED','MAHASISWA_IMPORT_PASSWORD_MODE','MAHASISWA_IMPORT_PASSWORD_PREFIX','MAHASISWA_IMPORT_PASSWORD_FIXED',
...
'VITE_REVERB_SCHEME','BLACKBOX_API_KEY',);
