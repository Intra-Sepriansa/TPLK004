...
file_to_crop = "/Users/intrasepriansa/Herd/TPLK004/resources/js/assets/admin/qr-builder/hari-icon.png"

if os.path.exists(file_to_crop):
    crop_transparency(file_to_crop)
else:
    print(f"Error: File not found - {file_to_crop}")
