...
import { ArrowLeft, MoreVertical, Search, Settings } from 'lucide-react';
...
export function ChatWindow({
    ...
    const getBackgroundStyle = (): React.CSSProperties => {
        switch (settings.wallpaperType) {
            ...
            case 'gradient':
                return {
                    background:
                        GRADIENT_PRESETS[settings.gradientId] ||
            ...
            case 'pattern':
                return {
                    backgroundColor: '#0b141a',
                    backgroundImage:
                        PATTERN_PRESETS[settings.patternId] ||
                        PATTERN_PRESETS['dots'],
                };
            case 'animated':
    ...
    return (
        <div className="flex h-full flex-col bg-[#0b141a]">
            {/* WhatsApp Header */}
            <div className="z-10 flex items-center justify-between bg-[#202c33] px-4 py-2">
                <div className="flex items-center gap-3">
                    <Button
                        variant="ghost"
                        size="icon"
                        onClick={onBack}
                        className="h-10 w-10 text-[#aebac1] hover:bg-[#374045] md:hidden"
                    >
                    ...
                    <div>
                        <h3 className="font-normal text-[#e9edef]">
                            {conversation.name}
                        </h3>
            ...
            <div
                ...
                className="relative flex-1 overflow-y-auto scroll-smooth px-4 py-2"
                style={
                    settings.wallpaperType === 'animated'
                        ? getAnimatedWallpaperStyle()
                        : getBackgroundStyle()
                }
            >
                {loading && (
            ...
            {/* Typing Indicator */}
            {typingUsers.length > 0 && (
                <div className="bg-[#0b141a] px-4 py-2">
                    <div className="inline-flex items-center gap-2 rounded-lg bg-[#202c33] px-3 py-2">
