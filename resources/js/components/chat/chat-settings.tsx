...
const GRADIENT_PRESETS = [
    {
        ...
        name: 'Aurora',
        gradient:
            'linear-gradient(135deg, #0b141a 0%, #1a4a3a 50%, #0b141a 100%)',
    },
    {
        id: 'sunset',
        name: 'Sunset',
    ...
    },
    {
        id: 'ocean-deep',
        name: 'Ocean Deep',
        gradient: 'linear-gradient(180deg, #0b141a 0%, #023e8a 100%)',
    },
    {
        id: 'forest-mist',
        name: 'Forest Mist',
        gradient: 'linear-gradient(180deg, #1b4332 0%, #0b141a 100%)',
    },
    {
        id: 'purple-haze',
        name: 'Purple Haze',
        gradient:
            'linear-gradient(135deg, #1a1a2e 0%, #4c1d95 50%, #1a1a2e 100%)',
    },
    {
        id: 'cosmic',
        name: 'Cosmic',
        gradient:
            'linear-gradient(135deg, #0f0f23 0%, #1e3a5f 25%, #4c1d95 50%, #1e3a5f 75%, #0f0f23 100%)',
    },
    {
        id: 'emerald',
        name: 'Emerald',
        gradient:
            'linear-gradient(135deg, #064e3b 0%, #0b141a 50%, #064e3b 100%)',
    },
    {
        id: 'rose-gold',
        name: 'Rose Gold',
        gradient:
            'linear-gradient(135deg, #1a1a1a 0%, #4a1942 50%, #1a1a1a 100%)',
    },
];
...
const PATTERN_PRESETS = [
    {
        id: 'dots',
        name: 'Dots',
        pattern: `url("data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23ffffff' fill-opacity='0.05'%3E%3Ccircle cx='3' cy='3' r='1.5'/%3E%3C/g%3E%3C/svg%3E")`,
    },
    {
        id: 'grid',
        name: 'Grid',
        pattern: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' stroke='%23ffffff' stroke-opacity='0.05'%3E%3Cpath d='M0 20h40M20 0v40'/%3E%3C/g%3E%3C/svg%3E")`,
    },
    {
        id: 'waves',
        name: 'Waves',
    ...
    },
    {
        id: 'hexagon',
        name: 'Hexagon',
        pattern: `url("data:image/svg+xml,%3Csvg width='28' height='49' viewBox='0 0 28 49' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' stroke='%23ffffff' stroke-opacity='0.05'%3E%3Cpath d='M13.99 9.25l13 7.5v15l-13 7.5L1 31.75v-15l12.99-7.5zM3 17.9v12.7l10.99 6.34 11-6.35V17.9l-11-6.34L3 17.9z'/%3E%3C/g%3E%3C/svg%3E")`,
    },
    {
        id: 'circuit',
        name: 'Circuit',
    ...
    },
    {
        id: 'topography',
        name: 'Topography',
        pattern: `url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M50 50c0-5.523 4.477-10 10-10s10 4.477 10 10-4.477 10-10 10c0 5.523-4.477 10-10 10s-10-4.477-10-10 4.477-10 10-10zM10 10c0-5.523 4.477-10 10-10s10 4.477 10 10-4.477 10-10 10c0 5.523-4.477 10-10 10S0 25.523 0 20s4.477-10 10-10zm10 8c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8zm40 40c4.418 0 8-3.582 8-8s-3.582-8-8-8-8 3.582-8 8 3.582 8 8 8z' fill='none' stroke='%23ffffff' stroke-opacity='0.03'/%3E%3C/svg%3E")`,
    },
];
    ...
    const getAnimationStyle = () => {
        ...
        switch (animatedId) {
            case 'wave':
                return {
                    background:
                        'linear-gradient(135deg, #0b141a 0%, #1a4a3a 25%, #0b141a 50%, #1a4a3a 75%, #0b141a 100%)',
            ...
            case 'particles':
                return {
                    background:
                        'radial-gradient(circle at 20% 80%, rgba(0, 168, 132, 0.15) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(0, 168, 132, 0.1) 0%, transparent 50%), radial-gradient(circle at 40% 40%, rgba(0, 168, 132, 0.08) 0%, transparent 30%), #0b141a',
                    animation: 'particles-animation 15s ease infinite',
                };
            case 'gradient-shift':
                return {
                    background:
                        'linear-gradient(270deg, #0b141a, #1a4a3a, #023e8a, #1a1a2e, #0b141a)',
            ...
            case 'aurora-borealis':
                return {
                    background:
                        'linear-gradient(180deg, #0b141a 0%, #064e3b 30%, #0891b2 50%, #064e3b 70%, #0b141a 100%)',
            ...
            case 'pulse':
                return {
                    background:
                        'radial-gradient(circle at center, #1a4a3a 0%, #0b141a 70%)',
...
function WallpaperPreview({ settings }: { settings: ChatSettings }) {
        ...
        switch (settings.wallpaperType) {
            ...
            case 'gradient':
                const gradient = GRADIENT_PRESETS.find(
                    (g) => g.id === settings.gradientId,
                );
                return { background: gradient?.gradient || '#0b141a' };
            case 'pattern':
                const pattern = PATTERN_PRESETS.find(
                    (p) => p.id === settings.patternId,
                );
                return {
                    backgroundColor: '#0b141a',
    ...
    return (
        <div className="relative h-40 w-full overflow-hidden rounded-lg border border-[#2a3942]">
            {settings.wallpaperType === 'animated' ? (
                <AnimatedBackground
                    animatedId={settings.animatedId}
                    isPlaying={true}
                />
            ) : (
            ...
            <div className="absolute inset-0 flex flex-col justify-end gap-2 p-3">
                {/* Incoming message */}
                <div className="flex">
                    <div className="max-w-[70%] rounded-lg rounded-tl-none bg-[#202c33] px-3 py-1.5">
                ...
                <div className="flex justify-end">
                    <div
                        className="max-w-[70%] rounded-lg rounded-tr-none px-3 py-1.5"
                        style={{ backgroundColor: settings.bubbleColor }}
                    >
                        <p className="text-xs text-[#e9edef]">
                            Baik! Kamu gimana?
                        </p>
                        <span className="text-[9px] text-[#ffffff99]">
                            10:31 ✓✓
                        </span>
                    </div>
                </div>
...
export function ChatSettingsPanel({
    ...
    const [wallpaperSubTab, setWallpaperSubTab] =
        useState<WallpaperSubTab>('gradient');
    ...
    return (
        <div className="fixed inset-0 z-50 flex animate-in items-center justify-center bg-black/60 p-4 backdrop-blur-sm duration-200 fade-in">
            <div className="flex max-h-[90vh] w-full max-w-lg animate-in flex-col overflow-hidden rounded-xl bg-[#111b21] duration-300 zoom-in-95">
                {/* Header */}
                <div className="flex items-center justify-between border-b border-[#2a3942] bg-[#202c33] px-4 py-3">
                    ...
                    <Button
                        ...
                        size="icon"
                        onClick={onClose}
                        className="text-[#aebac1] transition-colors hover:bg-[#374045]"
                    >
                        <X className="h-5 w-5" />
                    </Button>
                </div>
                ...
                {/* Tabs */}
                <div className="scrollbar-hide flex overflow-x-auto border-b border-[#2a3942]">
                    {tabs.map((tab) => (
                        <button
                            key={tab.id}
                            onClick={() => setActiveTab(tab.id)}
                            className={cn(
                                'flex min-w-[80px] flex-1 items-center justify-center gap-2 py-3 text-sm transition-all duration-200',
                                activeTab === tab.id
                                    ? 'border-b-2 border-[#00a884] bg-[#202c33]/50 text-[#00a884]'
                ...
                <div className="flex-1 overflow-y-auto p-4">
                    {activeTab === 'wallpaper' && (
                        <div className="animate-in space-y-4 duration-300 fade-in slide-in-from-right-2">
                            {/* Preview */}
                            <div>
                                <h3 className="mb-2 text-sm font-medium text-[#e9edef]">
                                    Preview
                                </h3>
                            ...
                            {/* Wallpaper Sub Tabs */}
                            <div className="flex gap-1 rounded-lg bg-[#202c33] p-1">
                                {wallpaperSubTabs.map((tab) => (
                                    <button
                                        key={tab.id}
                                        onClick={() =>
                                            setWallpaperSubTab(tab.id)
                                        }
                                        className={cn(
                                            'flex-1 rounded-md py-1.5 text-xs transition-all duration-200',
                            ...
                            {wallpaperSubTab === 'gradient' && (
                                <div className="animate-in duration-200 fade-in">
                                    <h3 className="mb-3 text-sm font-medium text-[#e9edef]">
                                        Wallpaper Gradien
                                    </h3>
                                    <div className="grid grid-cols-4 gap-2">
                                        {GRADIENT_PRESETS.map((preset) => (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    settings.wallpaperType ===
                                                        ...
                                                        settings.gradientId ===
                                                            preset.id
                                                        ? 'scale-105 border-[#00a884] shadow-lg shadow-[#00a884]/20'
                                                        : 'border-transparent hover:scale-102 hover:border-[#2a3942]',
                                                )}
                                                style={{
                                            ...
                                            >
                                                ...
                                                <span className="absolute right-1 bottom-1 left-1 truncate text-[9px] text-white/80 opacity-0 transition-opacity group-hover:opacity-100">
                                                    {preset.name}
                                                </span>
                                            </button>
                                        ))}
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        {PATTERN_PRESETS.map((preset) => (
                                            ...
                                            >
                                                ...
                                                <span className="absolute right-1 bottom-1 left-1 truncate text-center text-[10px] text-white/80">
                                                    {preset.name}
                                                </span>
                                            </button>
                                        ))}
                                ...
                                <div className="animate-in duration-200 fade-in">
                                    <div className="mb-3 flex items-center justify-between">
                                        ...
                                        <button
                                            ...
                                            className="flex items-center gap-1 text-xs text-[#00a884] transition-colors hover:text-[#00a884]/80"
                                        >
                                            {isAnimationPlaying ? (
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {ANIMATED_PRESETS.map((preset) => (
                                            <button
                                                ...
                                                className={cn(
                                                    'relative h-20 overflow-hidden rounded-lg border-2 transition-all duration-200',
                                                    settings.wallpaperType ===
                                                        'animated' &&
                                                        settings.animatedId ===
                                                            preset.id
                                ...
                                <div className="animate-in duration-200 fade-in">
                                    ...
                                    settings.wallpaper ? (
                                        <div className="group relative overflow-hidden rounded-lg">
                                            ...
                                            <div className="absolute inset-0 flex items-center justify-center gap-2 bg-black/50 opacity-0 transition-all duration-200 group-hover:opacity-100">
                                                <Button
                                                    ...
                                                    className="bg-[#00a884] hover:bg-[#00a884]/80"
                                                >
                                        ...
                                        <button
                                            ...
                                            className="flex h-28 w-full flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-[#2a3942] text-[#8696a0] transition-all duration-200 hover:border-[#00a884] hover:bg-[#00a884]/5 hover:text-[#00a884]"
                                        >
                    ...
                    {activeTab === 'theme' && (
                        <div className="animate-in space-y-6 duration-300 fade-in slide-in-from-right-2">
                            {/* Bubble Color */}
                            <div>
                                <h3 className="mb-3 text-sm font-medium text-[#e9edef]">
                                    Warna Bubble Chat
                                ...
                                <div className="grid grid-cols-6 gap-2">
                                    {BUBBLE_COLORS.map((bubble) => (
                                        <button
                                            ...
                                            className={cn(
                                                'group relative aspect-square rounded-full border-2 transition-all duration-200',
                            ...
                            <div>
                                <div className="mb-3 flex items-center justify-between">
                                    ...
                                    <span className="text-sm font-medium text-[#00a884]">
                                ...
                                <Slider
                                    ...
                                    className="w-full"
                                />
                                <div className="mt-2 flex justify-between text-xs text-[#8696a0]">
                                    ...
                                    {[
                                        {
                                            id: 'modern',
                                            name: 'Modern',
                                            desc: 'Sudut membulat dengan tail',
                                            preview:
                                        ...
                                        },
                                        {
                                            id: 'classic',
                                            name: 'Klasik',
                                            desc: 'Sudut sedikit membulat',
                                            preview: 'rounded-md',
                                        },
                                        {
                                            id: 'minimal',
                                            name: 'Minimal',
                                            desc: 'Tanpa tail, bersih',
                                            preview: 'rounded-lg',
                                        },
                                    ].map((style) => (
                                        <button
                                            ...
                                            onClick={() =>
                                                updateSetting(
                                                    'bubbleStyle',
                                                    style.id as ChatSettings['bubbleStyle'],
                                                )
                                            }
                                            className={cn(
                            ...
                            {/* Enter to Send */}
                            <div className="flex items-center justify-between rounded-lg bg-[#202c33] p-3 transition-colors hover:bg-[#202c33]/80">
                                <div>
                                    <p className="text-sm font-medium text-[#e9edef]">
                                        Enter untuk Kirim
                                    </p>
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) =>
                                        updateSetting('enterToSend', checked)
                                    }
                                />
                            </div>
                        </div>
                    ...
                    {activeTab === 'animations' && (
                        <div className="animate-in space-y-6 duration-300 fade-in slide-in-from-right-2">
                                    ...
                                    {MESSAGE_ANIMATIONS.map((anim) => (
                                        <button
                                            ...
                                            onClick={() =>
                                                updateSetting(
                                                    'messageAnimation',
                                                    anim.id as ChatSettings['messageAnimation'],
                                                )
                                            }
                                            className={cn(
                                                'flex w-full items-center justify-between rounded-lg border p-3 transition-all duration-200',
                                                settings.messageAnimation ===
                                                    anim.id
                                                    ? 'border-[#00a884] bg-[#00a884]/10'
                                                    : 'border-[#2a3942] hover:border-[#3a4a52] hover:bg-[#202c33]/50',
                                            )}
                                    ...
                                    {[
                                        ...
                                        <button
                                            ...
                                            onClick={() =>
                                                updateSetting(
                                                    'animationSpeed',
                                                    speed.id as ChatSettings['animationSpeed'],
                                                )
                                            }
                                            className={cn(
                                                'flex-1 rounded-lg border py-2 text-sm transition-all duration-200',
                            ...
                            <div className="rounded-lg border border-[#2a3942] bg-[#202c33] p-4">
                                <p className="mb-3 text-xs text-[#8696a0]">
                                    Preview Animasi:
                                </p>
                                <div className="space-y-2">
                                    <div
                                        className={cn(
                                            'inline-block rounded-lg px-3 py-1.5 text-sm text-[#e9edef]',
                                            settings.messageAnimation ===
                                                'slide' &&
                    ...
                    {activeTab === 'notifications' && (
                        <div className="animate-in space-y-3 duration-300 fade-in slide-in-from-right-2">
                            <div className="flex items-center justify-between rounded-lg bg-[#202c33] p-3 transition-colors hover:bg-[#202c33]/80">
                                <div>
                                    <p className="text-sm font-medium text-[#e9edef]">
                                        Suara Notifikasi
                        ...
                        <div className="animate-in space-y-3 duration-300 fade-in slide-in-from-right-2">
                            <div className="flex items-center justify-between rounded-lg bg-[#202c33] p-3 transition-colors hover:bg-[#202c33]/80">
                                <div>
                                    ...
                                    <p className="text-xs text-[#8696a0]">
                                        Tampilkan centang biru saat pesan dibaca
                                    </p>
                                </div>
                                <Switch
                            ...
                            <div className="flex items-center justify-between rounded-lg bg-[#202c33] p-3 transition-colors hover:bg-[#202c33]/80">
                                <div>
                                    ...
                                    <p className="text-xs text-[#8696a0]">
                                        Tampilkan status online/terakhir dilihat
                                    </p>
                                </div>
                                <Switch
                                    checked={settings.lastSeen}
                                    onCheckedChange={(checked) =>
                                        updateSetting('lastSeen', checked)
                                    }
                                />
                            </div>

                            <div className="mt-6 rounded-lg border border-[#2a3942] bg-[#182229] p-4">
                                <p className="text-xs leading-relaxed text-[#8696a0]">
                                    💡 Jika kamu menonaktifkan tanda dibaca,
                                    kamu juga tidak akan bisa melihat tanda
                                    dibaca dari orang lain.
                                </p>
                            </div>
                        </div>
                    )}
                ...
                {/* Footer */}
                <div className="border-t border-[#2a3942] bg-[#202c33] px-4 py-3">
                    <Button
                        onClick={onClose}
                        className="w-full bg-[#00a884] text-white transition-all duration-200 hover:bg-[#00a884]/80 hover:shadow-lg hover:shadow-[#00a884]/20"
                    >
                        Simpan & Tutup
                    </Button>
                </div>
