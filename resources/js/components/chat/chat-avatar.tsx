    ...
    const colors = [
        {
            bg: '#00a884',
            text: '#ffffff',
            gradient: 'from-[#00a884] to-[#00d4aa]',
        },
        {
            bg: '#7c3aed',
            text: '#ffffff',
        ...
        },
        {
            bg: '#0088cc',
            text: '#ffffff',
            gradient: 'from-[#0088cc] to-[#00b4ff]',
        },
        {
            bg: '#db2777',
            text: '#ffffff',
    ...
    if (avatar && !imageError) {
        return (
            <div className={cn('relative flex-shrink-0', className)}>
                <div
                    className={cn(
                        'overflow-hidden rounded-full ring-2 ring-transparent transition-all duration-200 hover:ring-[#00a884]/30',
                        sizeClasses[size],
                    )}
                >
                    <img
                ...
                {showOnlineIndicator && type === 'personal' && isOnline && (
                    <div
                        className={cn(
                            'absolute right-0 bottom-0 animate-pulse rounded-full border-[#111b21] bg-[#00a884]',
        ...
        <div className={cn('relative flex-shrink-0', className)}>
            <div
                className={cn(
                    ...
                    'ring-2 ring-transparent transition-all duration-200 hover:ring-[#00a884]/30',
            ...
            >
                {type === 'group' ? (
                    ...
                    <span className="font-medium tracking-wide text-white drop-shadow-sm">
                        {initials}
                    </span>
                )}
            </div>
            ...
            {showOnlineIndicator && type === 'personal' && isOnline && (
                <div
                    className={cn(
                        'absolute right-0 bottom-0 rounded-full border-[#111b21] bg-[#00a884]',
                        onlineIndicatorSizes[size],
                    )}
                >
                    <div className="absolute inset-0 animate-ping rounded-full bg-[#00a884] opacity-75" />
                </div>
            )}
        </div>
    );
...
export function ChatAvatarAdvanced({
            ...
            <div className={cn('group relative flex-shrink-0', className)}>
                ...
                <div
                    className={cn(
                        ...
                        'scale-110 bg-gradient-to-r from-[#00a884]/20 to-[#00d4aa]/20 blur-md',
                    )}
                />

                <div
                    className={cn(
                        'relative overflow-hidden rounded-full ring-2 transition-all duration-300',
                ...
                {showOnlineIndicator && type === 'personal' && (
                    <div
                        className={cn(
                            'absolute right-0 bottom-0 rounded-full border-[#111b21] transition-all duration-300',
    ...
    return (
        <div className={cn('group relative flex-shrink-0', className)}>
            ...
            <div
                className={cn(
                    'absolute inset-0 scale-125 rounded-full opacity-0 blur-md transition-opacity duration-300 group-hover:opacity-100',
                )}
            ...
            <div
                className={cn(
                    ...
                    'group-hover:scale-105 group-hover:shadow-xl group-hover:ring-4',
                    statusColors[currentStatus],
                    sizeClasses[size],
                )}
                style={{
            ...
            >
                ...
                {type === 'group' ? (
                    ...
                    <span className="relative z-10 font-bold tracking-wide text-white drop-shadow-md">
                        {initials}
                    </span>
                )}
            </div>
                ...
                >
                    {currentStatus === 'active' && (
                        <div
                            ...
                            style={{
                                background: statusIndicatorColors[
                                    currentStatus
                                ].replace('bg-', ''),
                            }}
                        />
