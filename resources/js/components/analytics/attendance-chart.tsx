        ...
        switch (type) {
            ...
            case 'pie':
                const pieData = [
                    {
                        name: 'Hadir',
                        value: chartData.reduce((sum, d) => sum + d.Hadir, 0),
                        color: COLORS.present,
                    },
                    {
                        name: 'Terlambat',
                        value: chartData.reduce(
                            (sum, d) => sum + d.Terlambat,
                            0,
                        ),
                        color: COLORS.late,
                    },
