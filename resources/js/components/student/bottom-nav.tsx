...
import { Award, FileText, Home, QrCode, User } from 'lucide-react';
...
export function BottomNav() {
    ...
    return (
        <nav className="fixed right-0 bottom-0 left-0 z-40 border-t border-slate-200 bg-white/95 backdrop-blur-lg lg:hidden dark:border-slate-800 dark:bg-slate-950/95">
