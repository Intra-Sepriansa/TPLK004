...
export function TugasCreateModalEnhanced({
    isOpen,
    onClose,
    form,
    setForm,
        ...
        <AnimatePresence>
            ...
            >
                ...
                <div className="pointer-events-none absolute inset-0 overflow-hidden">
                    {[...Array(25)].map((_, i) => (
                        <motion.div
                            ...
                            className="absolute h-2 w-2 rounded-full bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-500 blur-sm"
                        />
                    ))}
                </div>
                ...
                <motion.div
                    ...
                    className="relative flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-3xl border border-gray-200/50 bg-white/98 shadow-2xl backdrop-blur-2xl dark:border-gray-800/50 dark:bg-black/98"
                    style={{
                        perspective: '1500px',
                ...
                >
                    ...
                    <div className="flex-1 space-y-5 overflow-y-auto p-6">
                        ...
                        >
                            ...
                            >
                                <SelectTrigger className="border-2 border-slate-200 bg-white text-slate-900 focus:ring-4 focus:ring-blue-500/20 dark:border-slate-700 dark:bg-gray-800 dark:text-white">
                        ...
                        >
                            ...
                            <Input
                                ...
                                className="border-2 border-slate-200 bg-white text-slate-900 focus:ring-4 focus:ring-emerald-500/20 dark:border-slate-700 dark:bg-gray-800 dark:text-white"
                        ...
                        >
                            ...
                            <Textarea
                                ...
                                rows={4}
                                className="resize-none border-2 border-slate-200 bg-white text-slate-900 focus:ring-4 focus:ring-violet-500/20 dark:border-slate-700 dark:bg-gray-800 dark:text-white"
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    <SelectTrigger className="border-2 border-slate-200 bg-white text-slate-900 focus:ring-4 focus:ring-amber-500/20 dark:border-slate-700 dark:bg-gray-800 dark:text-white">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                            ...
                            <div>
                                ...
                                >
                                    <SelectTrigger className="border-2 border-slate-200 bg-white text-slate-900 focus:ring-4 focus:ring-rose-500/20 dark:border-slate-700 dark:bg-gray-800 dark:text-white">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    className="border-2 border-slate-200 bg-white text-slate-900 focus:ring-4 focus:ring-cyan-500/20 dark:border-slate-700 dark:bg-gray-800 dark:text-white"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                >
                                    <SelectTrigger className="border-2 border-slate-200 bg-white text-slate-900 focus:ring-4 focus:ring-green-500/20 dark:border-slate-700 dark:bg-gray-800 dark:text-white">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                    ...
                    <div className="border-t-2 border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100 p-6 backdrop-blur dark:border-gray-800 dark:from-gray-900/50 dark:to-black/50">
                        <div className="flex gap-3">
                            ...
                            >
                                <Button
                                    onClick={onSubmit}
                                    className="w-full border-0 bg-gradient-to-r from-gray-900 to-black shadow-lg hover:from-gray-800 hover:to-gray-900"
                                >
