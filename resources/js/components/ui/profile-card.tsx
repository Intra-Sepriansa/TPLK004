...
import '@/components/ui/profile-card.css';
...
const DEFAULT_ICON_URL = '/images/profile-code-mask.svg';
const DEFAULT_GRAIN_URL = '/images/profile-grain.svg';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    const cardStyle = useMemo(() => ({
        '--icon': `url(${iconUrl ?? DEFAULT_ICON_URL})`,
        '--grain': `url(${grainUrl ?? DEFAULT_GRAIN_URL})`,
    ...
    const displayTitle = title || 'Member';
    const displayAvatar = avatarUrl;
    const displayMiniAvatar = miniAvatarUrl || avatarUrl;
