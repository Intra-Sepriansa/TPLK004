    ...
    return (
        ...
        >
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-6">
                        <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:gap-6 sm:text-left">
                            ...
                            <div className="mt-1 flex-1 sm:mt-0">
                                ...
                                >
                                    Pantau kehadiran mahasiswa secara real-time
                                    dengan sistem absensi berbasis AI, QR code
                                    dinamis, dan verifikasi selfie.
                                </motion.p>
                            </div>
                        </div>
            ...
            >
                {stats.map((stat, index) => {
                    ...
                    return (
                        <motion.div
                            key={stat.title}
                            className={`group relative overflow-hidden rounded-2xl border border-white/20 bg-white/40 p-3 shadow-xl backdrop-blur-xl transition-all sm:rounded-3xl sm:p-6 dark:bg-neutral-900/40 ${colorConfig.hoverShadow} dark:border-white/5`}
                            variants={{
                                hidden: { opacity: 0, y: 30, scale: 0.9 },
                                visible: {
                                    opacity: 1,
                        ...
                        >
                            <div
                                className={`absolute inset-0 bg-gradient-to-br ${colorConfig.gradientBg}`}
                            />
                            <motion.div
                                initial={false}
                                animate={{
                                ...
                                className={`absolute -top-10 -right-10 h-32 w-32 rounded-full ${colorConfig.bg} blur-3xl transition-all duration-500`}
                            />
            ...
            >
                ...
                >
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-2 text-center text-xs">
                        <div className="rounded-xl bg-emerald-50/80 p-2 backdrop-blur dark:bg-emerald-900/20">
                            <p className="font-semibold text-emerald-600">
                                {stats[0]?.value ?? 0}
                            </p>
                            <p className="text-emerald-600/70">Hadir</p>
                        </div>
                        <div className="rounded-xl bg-amber-50/80 p-2 backdrop-blur dark:bg-amber-900/20">
                            <p className="font-semibold text-amber-600">
                                {stats[1]?.value ?? 0}
                            </p>
                            <p className="text-amber-600/70">Terlambat</p>
                        </div>
                        <div className="rounded-xl bg-rose-50/80 p-2 backdrop-blur dark:bg-rose-900/20">
                        ...
                        {activity.length === 0 ? (
                            ...
                            activity.slice(0, 5).map((item, idx) => {
                                ...
                                return (
                                    <motion.div
                                        key={item.id}
                                        className="flex items-center gap-4 rounded-2xl bg-neutral-50/50 p-3 backdrop-blur transition-colors hover:bg-neutral-100/60 dark:bg-neutral-800/50 dark:hover:bg-neutral-700/50"
                    ...
                    <div className="space-y-3">
                        {(topStudents ?? []).length === 0 ? (
                            ...
                            (topStudents ?? []).map((student, index) => (
                                <motion.div
                                    key={student.id}
                                    className="flex items-center gap-3 rounded-xl bg-neutral-50/50 p-2 backdrop-blur transition-colors hover:bg-neutral-100/60 dark:bg-neutral-800/50 dark:hover:bg-neutral-700/50"
                                    initial={{ opacity: 0, x: -20 }}
                                    animate={{ opacity: 1, x: 0 }}
                ...
                >
                    <div className="mb-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-neutral-500">
                                    Perbandingan antar mata kuliah
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="h-64">
                        {(courseStats ?? []).length === 0 ? (
                            <div className="flex h-full items-center justify-center rounded-2xl border border-white/10 bg-neutral-50/50 text-sm text-neutral-500 dark:bg-neutral-800/50">
            ...
            >
                ...
                >
                    <div
                        className={`absolute inset-0 bg-gradient-to-br ${activeSession ? 'from-emerald-500/5 to-teal-500/5 dark:from-emerald-500/10 dark:to-teal-500/10' : 'from-neutral-500/5 to-neutral-500/5'}`}
                    />
                    <div className="relative">
                        <div className="mb-4 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <div
                                    className={`flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br ${activeSession ? 'from-emerald-400 to-teal-600 shadow-emerald-500/30' : 'from-neutral-400 to-neutral-600 shadow-neutral-500/30'} text-white shadow-lg`}
                                >
                            ...
                            <span
                                className={`inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs font-semibold ${activeSession ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300' : 'bg-neutral-100 text-neutral-600 dark:bg-neutral-800 dark:text-neutral-400'}`}
                            >
                                <span
                                    className={`h-2 w-2 rounded-full ${activeSession ? 'animate-pulse bg-emerald-500' : 'bg-neutral-400'}`}
                                />
                        ...
                        {activeSession ? (
                            <div className="space-y-3">
                                <div className="rounded-2xl bg-gradient-to-br from-indigo-50/80 to-purple-50/80 p-4 backdrop-blur dark:from-indigo-900/20 dark:to-purple-900/20">
                                ...
                                <div className="grid grid-cols-2 gap-2 text-sm">
                                    <div className="rounded-xl bg-neutral-50/80 p-3 backdrop-blur dark:bg-neutral-800/50">
                                        <p className="text-xs text-neutral-500">
                                            Scan masuk
                                        </p>
                                        <p className="font-semibold text-neutral-900 dark:text-white">
                            ...
                            <div className="rounded-2xl border border-white/10 bg-neutral-50/50 p-6 text-center dark:bg-neutral-800/50">
                                <Zap className="mx-auto mb-2 h-8 w-8 text-neutral-300" />
                                <p className="text-sm text-neutral-500">
                ...
                >
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between rounded-2xl bg-neutral-50/80 p-3 backdrop-blur dark:bg-neutral-800/50">
                            ...
                            <div className="flex items-center justify-between rounded-2xl bg-neutral-50/80 p-3 backdrop-blur dark:bg-neutral-800/50">
                                ...
                                <span className="font-semibold text-amber-600">
                                    {securitySummary?.expired_tokens ?? 0}
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-3">
                            {upcomingSessions.length === 0 ? (
                                ...
                                upcomingSessions.slice(0, 3).map((session) => (
                                    <div
                                        key={session.id}
                                        className="rounded-2xl bg-neutral-50/80 p-3 backdrop-blur dark:bg-neutral-800/50"
                                    >
            ...
            >
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <motion.a
                        href="/admin/qr-builder"
                        className="group flex items-center gap-4 rounded-2xl border border-white/20 bg-neutral-50/50 p-4 backdrop-blur transition-all hover:bg-white/80 hover:shadow-lg dark:border-white/5 dark:bg-neutral-800/50 dark:hover:bg-neutral-800/80"
