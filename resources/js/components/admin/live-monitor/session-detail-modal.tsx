...
import { CheckCircle, Clock, Play, Users, X, XCircle } from 'lucide-react';
import {
    Area,
    AreaChart,
    CartesianGrid,
                ...
                >
                    ...
                    <div className="fixed inset-0 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="space-y-5 bg-neutral-50 p-6 dark:bg-neutral-950/50">
                                {/* Stats Grid */}
                                <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
                                    ...
                                    {['Hadir', 'Terlambat', 'Ditolak'].map(
                                        (label, idx) => (
                                            <div
                                                key={label}
                                                className="rounded-xl border border-neutral-200 bg-white p-3 text-center opacity-75 dark:border-neutral-800 dark:bg-neutral-900"
                                            >
                                ...
                                <button
                                    onClick={onClose}
                                    className="w-full rounded-xl bg-neutral-900 py-3 font-bold text-white shadow-lg transition-transform hover:opacity-90 active:scale-[0.98] dark:bg-white dark:text-neutral-900"
                                >
                                    Tutup Detail
                                </button>
                            </div>
