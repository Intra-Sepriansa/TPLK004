...
export { AttendanceChart } from './analytics/attendance-chart';
export { CourseComparison } from './analytics/course-comparison';

// Security Components
export { LivenessDetection } from './security/liveness-detection';
export { LocationValidator } from './security/location-validator';

// Audit Components
export { AuditLogViewer } from './audit/audit-log-viewer';
...
export { SwipeNavigation } from './mobile/swipe-navigation';
