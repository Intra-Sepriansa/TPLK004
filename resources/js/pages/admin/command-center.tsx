...
export default function CommandCenter({
    ...
    return (
        <>
            ...
            <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
                ...
                >
                    ...
                    >
                        ...
                        <div className="relative flex items-center justify-between">
                            ...
                            >
                                <div className="flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-4 py-2 backdrop-blur-xl">
                                    <motion.div
                    ...
                    <AnimatePresence>
                        {alerts.length > 0 && (
                            ...
                            >
                                <Card className="relative overflow-hidden border-2 border-red-500/50 bg-red-500/5">
                                    {/* Animated warning stripe */}
                                    <motion.div
                                        className="absolute top-0 right-0 left-0 h-1 bg-gradient-to-r from-transparent via-red-500 to-transparent"
                                        animate={{
                                            x: ['-100%', '100%'],
                                        }}
                                        transition={{
                                                ...
                                                <div className="flex items-start justify-between">
                                                    ...
                                                    {alert.action_url && (
                                                        <motion.a
                                                            ...
                                                            className="rounded-lg bg-white/50 px-3 py-1 text-sm font-medium transition-colors hover:bg-white/80"
                                                        >
                                                            View
                                                        </motion.a>
                                                    )}
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        >
                            <Card className="relative overflow-hidden border-blue-500/20 bg-gradient-to-br from-blue-500/10 to-blue-600/10">
                                {/* Glow effect */}
                                <motion.div
                                ...
                                <CardContent className="relative z-10">
                                    ...
                                    <div className="mt-4 space-y-2">
                                        ...
                                        >
                                            ...
                                            <motion.span
                                                className="flex items-center gap-1 font-semibold text-green-600 dark:text-green-400"
                                                animate={{
                                                    scale: [1, 1.1, 1],
                                                }}
                                                transition={{
                            ...
                            <Card className="border-green-500/20 bg-gradient-to-br from-green-500/10 to-green-600/10">
                                ...
                                <CardContent>
                                    <div className="text-3xl font-bold text-green-600 dark:text-green-400">
                                        {stats.attendance.attendance_rate.toFixed(
                                            1,
                                        )}
                                        %
                                    </div>
                                    ...
                                    {recentActivity.map((activity, index) => {
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                className="flex items-start gap-4 rounded-lg p-3 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800"
                                            >
