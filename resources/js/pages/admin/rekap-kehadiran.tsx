            ...
            <div className="p-6 space-y-6">
                ...
                >
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="font-semibold text-slate-900 dark:text-white text-lg">Filter Data</h2>
                    </div>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="font-semibold text-slate-900 dark:text-white text-lg">Tren Kehadiran Harian</h2>
                        </div>
                        <div className="h-64">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="font-semibold text-slate-900 dark:text-white text-lg">Distribusi Per Jam</h2>
                        </div>
                        <div className="h-64">
                            <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    <motion.div
                        ...
                        className="lg:col-span-2 rounded-2xl bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-black shadow-xl border border-slate-200 dark:border-slate-800/50 overflow-hidden"
                    >
                        <div className="p-6 border-b border-slate-800">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="font-semibold text-slate-900 dark:text-white text-lg">Ringkasan Per Mata Kuliah</h2>
                            </div>
                        </div>
                        <div className="overflow-x-auto max-h-80">
                            <table className="w-full">
                                <thead className="sticky top-0 bg-slate-100 dark:bg-slate-800/50 backdrop-blur">
                                    <tr>
                                        <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase">Mata Kuliah</th>
                                        <th className="px-4 py-3 text-center text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase">Sesi</th>
                                        <th className="px-4 py-3 text-center text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase">Hadir</th>
                                        <th className="px-4 py-3 text-center text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase">Terlambat</th>
                                        <th className="px-4 py-3 text-center text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase">Rate</th>
                                    </tr>
                                </thead>
                                        ...
                                        courseSummary.map((course, index) => (
                                            ...
                                            >
                                                <td className="px-4 py-3">
                                                    ...
                                                    <p className="text-xs text-slate-600 dark:text-slate-400">{course.dosen}</p>
                                                </td>
                                                <td className="px-4 py-3 text-center text-sm text-slate-700 dark:text-slate-300">{course.total_sessions}</td>
                                                <td className="px-4 py-3 text-center text-sm text-emerald-600 dark:text-emerald-400 font-medium">{course.present}</td>
                                                <td className="px-4 py-3 text-center text-sm text-amber-600 dark:text-amber-400 font-medium">{course.late}</td>
                                                <td className="px-4 py-3 text-center">
                                                    <span className={`inline-flex px-2 py-1 rounded-full text-xs font-bold ${
                                                        course.rate >= 80 ? 'bg-emerald-500/20 text-emerald-600 dark:text-emerald-400' :
                                                        course.rate >= 60 ? 'bg-amber-500/20 text-amber-600 dark:text-amber-400' :
                                    ...
                                    topAttendees.map((student, i) => (
                                        ...
                                        >
                                            <div className={`flex h-7 w-7 items-center justify-center rounded-full text-xs font-bold ${
                                                ...
                                                i === 1 ? 'bg-slate-500/20 text-slate-600 dark:text-slate-400' :
                                                i === 2 ? 'bg-amber-500/20 text-amber-600 dark:text-amber-400' :
                                                'bg-slate-700/50 text-slate-600 dark:text-slate-400'
                                            }`}>
                                                {i + 1}
                                            </div>
                                            ...
                                            <span className="text-sm font-bold text-emerald-600 dark:text-emerald-400">{student.total_attendance}x</span>
                                        </motion.div>
                                    ))
                                )}
                            </div>
                                ...
                                {lowAttendance.length === 0 ? (
                                    ...
                                    lowAttendance.map((student, index) => (
                                        ...
                                        >
                                            ...
                                            <span className="text-sm font-bold text-red-600 dark:text-red-400">{student.rate}%</span>
                                        </motion.div>
                                    ))
                                )}
                            </div>
                ...
                >
                    <div className="p-6 border-b border-slate-800">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="font-semibold text-slate-900 dark:text-white text-lg">Detail Kehadiran</h2>
                            </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead>
                                <tr className="bg-slate-100 dark:bg-slate-800/50 backdrop-blur">
                                    ...
                                    <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase">Selfie</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-800">
                                            ...
                                            <td className="px-4 py-3">
                                                {log.mahasiswa ? (
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-slate-600 dark:text-slate-400">{log.mahasiswa.nim}</p>
                                                    </div>
                                                ) : (
                                            ...
                                            <td className="px-4 py-3">
                                                {log.selfie_verification ? (
                                                    <span className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${
                                                        log.selfie_verification.status === 'approved' ? 'bg-emerald-500/20 text-emerald-600 dark:text-emerald-400' :
                                                        log.selfie_verification.status === 'pending' ? 'bg-amber-500/20 text-amber-600 dark:text-amber-400' :
                                                        'bg-red-500/20 text-red-600 dark:text-red-400'
                                                    }`}>
