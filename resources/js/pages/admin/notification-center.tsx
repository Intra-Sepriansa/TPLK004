...
export default function NotificationCenter({
    ...
    const handleConfirmDelete = () => {
        if (deleteDialog.mode === 'bulk') {
            if (selectedIds.length === 0) return;
            router.post(
                '/admin/notification-center/bulk-delete',
                { ids: selectedIds },
                {
                    onSuccess: () => {
                        setSelectedIds([]);
    ...
    const getPriorityBadge = (priority: string) => {
        switch (priority) {
            ...
            case 'high':
                return (
                    <span className="rounded-full bg-orange-500/20 px-2 py-1 text-xs font-medium text-orange-600 dark:text-orange-400">
                        High
                    </span>
                );
            case 'normal':
                return (
                    <span className="rounded-full bg-blue-500/20 px-2 py-1 text-xs font-medium text-blue-600 dark:text-blue-400">
                        Normal
                    </span>
                );
            default:
            ...
            >
                ...
                >
                    ...
                    <div className="relative flex flex-col justify-between gap-6 md:flex-row md:items-center md:gap-4">
                        ...
                        <motion.div
                            className="mx-auto flex w-fit shrink-0 justify-center md:mx-0 md:justify-end"
                        ...
                        >
                            <div className="flex flex-col gap-3 sm:flex-row">
                                <motion.button
                                    type="button"
                                    onClick={() =>
                                        router.get('/admin/weekly-digest')
                                    }
                                    className="flex w-fit items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/20 px-6 py-3.5 text-sm font-semibold shadow-lg backdrop-blur-xl transition-colors hover:bg-white/30"
                                ...
                                <motion.button
                                    ...
                                    onClick={() =>
                                        router.get(
                                            '/admin/notification-center/create',
                                        )
                                    }
                                    className="flex w-fit items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/20 px-6 py-3.5 text-sm font-semibold shadow-lg backdrop-blur-xl transition-colors hover:bg-white/30"
                                    whileHover={{ scale: 1.03, y: -2 }}
                    ...
                    <motion.p
                        ...
                        className="relative mt-4 text-center text-blue-100/80 sm:text-left"
                    >
                ...
                >
                    {[
                        ...
                        {
                            title: 'Recipients',
                            value: (mahasiswaCount + dosenCount).toString(),
                            change: 'Users',
                            isUp: true,
                        ...
                        const colorConfigs: Record<string, StatColorConfig> = {
                            ...
                            blue: {
                                ...
                                gradientBg:
                                    'from-blue-500/5 to-sky-500/5 dark:from-blue-500/10 dark:to-sky-500/10',
                            },
                            indigo: {
                                ...
                                gradientBg:
                                    'from-indigo-500/5 to-violet-500/5 dark:from-indigo-500/10 dark:to-violet-500/10',
                            },
                            emerald: {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`group relative overflow-hidden rounded-2xl border border-white/20 bg-white/40 p-4 shadow-xl backdrop-blur-xl transition-all sm:rounded-3xl sm:p-6 dark:bg-neutral-900/40 ${colorConfig.hoverShadow} dark:border-white/5`}
                            >
                                <div
                                    ...
                                    <div className="relative flex flex-col items-center gap-2 text-center sm:flex-row sm:items-start sm:gap-4 sm:text-left">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <div className="mt-1 flex items-center justify-center gap-1 sm:justify-start">
                                                <div
                                                    className={`flex items-center gap-0.5 rounded-sm border px-1.5 py-0.5 text-[8px] font-bold sm:text-[10px] ${
                                                        stat.isUp
                ...
                >
                    ...
                    <div className="flex flex-col flex-wrap items-stretch gap-3 sm:flex-row sm:items-center">
                        ...
                        >
                            <SelectTrigger className="w-full border-neutral-200 bg-white/60 text-neutral-900 sm:w-[200px] dark:border-neutral-700 dark:bg-neutral-800 dark:text-white">
                        ...
                        <motion.button
                            ...
                            className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-indigo-500/20 transition-all hover:shadow-indigo-500/30 sm:ml-auto sm:w-auto md:ml-0"
                        >
                        ...
                        <AnimatePresence>
                            {selectedIds.length > 0 && (
                                <motion.button
                                    ...
                                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-500 to-rose-600 px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-red-500/20 transition-all sm:ml-auto sm:w-auto"
                                >
                    ...
                    <div className="mb-5 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-neutral-500">
                                {notifications.data.length} notifikasi ditemukan
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className={cn(
                                            ...
                                            borderAccent,
                                            isUnread
                                                ? 'border border-blue-100 ring-1 ring-blue-500/10 dark:border-blue-900/30'
                                                : 'border border-white/20 dark:border-neutral-800',
                                        )}
                                    >
                                        {/* Unread glow effect */}
                                        {isUnread && (
                                            <div className="pointer-events-none absolute top-0 right-0 h-32 w-32 bg-gradient-to-bl from-blue-500/5 to-transparent" />
                                        )}
                                        ...
                                        <div className="p-5">
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <div
                                                        className={cn(
                                                            'absolute inset-0 rounded-2xl bg-gradient-to-br opacity-30 blur-lg transition-opacity group-hover:opacity-50',
                                                            typeColor,
                                                        )}
                                                    />
                                                </div>
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    <div className="mb-1.5 flex flex-wrap items-center gap-2.5">
                                                        ...
                                                        notification.total_recipients >
                                                            0 ? (
                                                            <span className="inline-flex items-center gap-1 rounded-full bg-emerald-500/15 px-2.5 py-0.5 text-xs font-medium text-emerald-600 ring-1 ring-emerald-500/20 dark:text-emerald-400">
                                                                <Eye className="h-3 w-3" />
                                                                Semua Dibaca
                                                            </span>
                                                        ) : notification.read_count >
                                                          0 ? (
                                                            <span className="inline-flex items-center gap-1 rounded-full bg-blue-500/15 px-2.5 py-0.5 text-xs font-semibold text-blue-600 ring-1 ring-blue-500/20 dark:text-blue-400">
                                                            ...
                                                            <span className="inline-flex items-center gap-1 rounded-full bg-neutral-100 px-2.5 py-0.5 text-xs font-semibold text-neutral-500 ring-1 ring-neutral-200 dark:bg-neutral-800 dark:ring-neutral-700">
                                                                0/
                                                                {
                                                                    notification.total_recipients
                                                                }{' '}
                                                        ...
                                                        {notification.scheduled_at && (
                                                            <span className="inline-flex items-center gap-1 rounded-full bg-amber-500/15 px-2.5 py-0.5 text-xs font-medium text-amber-600 ring-1 ring-amber-500/20 dark:text-amber-400">
                                                ...
                                                <div className="flex flex-col items-center gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                                                    <motion.button
                                                        ...
                                                        onClick={() =>
                                                            router.get(
                                                                `/admin/notification-center/${notification.id}`,
                                                            )
                                                        }
                                                        className="rounded-xl border border-blue-200/50 bg-blue-50 p-2 text-blue-500 shadow-sm transition-all hover:bg-blue-100 dark:border-blue-800/50 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/40"
                                                    ...
                                                    <motion.button
                                                        ...
                                                        className="rounded-xl border border-red-200/50 bg-red-50 p-2 text-red-500 shadow-sm transition-all hover:bg-red-100 dark:border-red-800/50 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/40"
                        ...
                        {notifications.data.length === 0 && (
                            <motion.div
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                                className="rounded-3xl border border-white/20 bg-white/40 p-16 text-center backdrop-blur-xl dark:bg-neutral-900/40"
                            >
                                <div className="relative mb-6 inline-block">
                                    ...
                                    >
                                        <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-3xl border-2 border-dashed border-blue-200 bg-gradient-to-br from-blue-500/10 to-indigo-500/10 dark:border-blue-800">
                                            <Bell className="h-12 w-12 text-blue-400/50" />
                                        </div>
                                    </motion.div>
                                    <div className="absolute bottom-0 left-1/2 h-2 w-16 -translate-x-1/2 rounded-full bg-black/5 blur-sm dark:bg-white/5" />
                                </div>
                                <p className="mb-1 text-lg font-bold text-neutral-800 dark:text-neutral-300">
                                    Tidak ada notifikasi
                                </p>
                                <p className="mx-auto max-w-xs text-sm text-neutral-500">
                                    Belum ada notifikasi yang cocok dengan
                                    filter. Buat notifikasi baru untuk memulai.
                                </p>
                            </motion.div>
                        )}
                    </div>
                            ...
                            <motion.button
                                ...
                                className={cn(
                                    ...
                                    link.active
                                        ...
                                        : link.url
                                          ? 'border border-neutral-200 bg-white/60 text-neutral-600 hover:bg-white/80 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400'
                                          : 'cursor-not-allowed bg-neutral-100 text-neutral-400 dark:bg-neutral-900',
                                )}
