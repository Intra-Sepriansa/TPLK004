            ...
            >
                ...
                >
                        ...
                        <div className="flex items-center gap-3 sm:gap-4">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="mt-2 max-w-2xl text-sm text-white/90 sm:text-base">
                                    Kelola tugas per mata kuliah dengan data
                                    real untuk {mahasiswa.nama}.
                                </p>
                            </div>
                        </div>
                    ...
                    >
                        <Button
                            onClick={() =>
                                router.visit('/user/akademik/tugas-kelompok')
                            }
                            className="border border-white/30 bg-white/20 text-white shadow-lg backdrop-blur hover:bg-white/30"
                        >
                ...
                >
                    {statsCards.map((stat) => (
                        ...
                        >
                            ...
                            />
                            <div
                                className={`pointer-events-none absolute -top-10 -right-10 h-32 w-32 rounded-full blur-3xl ${stat.glow}`}
                            />
                            ...
                            <div className="relative flex flex-col items-center gap-2 text-center sm:flex-row sm:items-start sm:gap-4 sm:text-left">
                                ...
                                />
                                <div>
                                    <p className="text-[10px] leading-tight font-medium text-neutral-600 sm:text-sm dark:text-neutral-400">
                                        {stat.label}
                                    </p>
                ...
                >
                    <div className="mb-4 flex items-center gap-3">
                        ...
                        <h2 className="text-sm font-semibold text-neutral-900 sm:text-base dark:text-white">
                            Filter Informasi Tugas
                        </h2>
                    </div>
                ...
                >
                    <div className="flex items-center gap-3 border-b border-white/20 p-4 sm:p-6 dark:border-white/5">
                    ...
                    <div className="p-4 sm:p-5">
                        {tugasList.length === 0 ? (
                            <div className="py-14 text-center sm:py-16">
                                ...
                                <p className="text-lg font-semibold text-neutral-700 sm:text-xl dark:text-neutral-300">
                                    Belum ada tugas
                                </p>
                                <p className="mt-2 text-sm text-neutral-500">
                                    Tugas dari dosen akan tampil otomatis di
                                    halaman ini.
                                </p>
                            </div>
                        ) : (
                                        ...
                                        <motion.div
                                            ...
                                            className={`group cursor-pointer rounded-3xl border p-4 transition-all duration-300 hover:shadow-xl sm:p-5 ${
                                                tugas.is_overdue
                                                    ...
                                                    : !tugas.is_read
                                                      ? 'border-l-4 border-white/20 border-l-blue-500 bg-white/60 dark:border-white/5 dark:bg-neutral-800/60'
                                            ...
                                            <div className="flex items-start justify-between gap-4">
                                                <div className="flex-1">
                                                    <div className="mb-3 flex flex-wrap items-center gap-2">
                                                        ...
                                                        <span
                                                            className={`inline-flex items-center gap-1.5 rounded-xl px-3 py-1.5 text-xs font-semibold shadow-lg ${priorityConfig.bg} ${priorityConfig.text}`}
                                                        >
