                        ...
                        <div className="flex flex-wrap items-start justify-between gap-6">
                            <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:gap-6 sm:text-left">
                                ...
                                <div className="mt-1 flex-1 sm:mt-0">
                                    ...
                                    >
                                        Informasi lengkap notifikasi yang
                                        diterima
                                    </motion.p>
                                </div>
                            </div>
                ...
                <div className="grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-3">
                    {[
                        ...
                        >
                            ...
                            <motion.div
                                className={cn(
                                    'absolute -top-10 -right-10 h-32 w-32 rounded-full opacity-20 blur-3xl',
                                    stat.orbColor,
                                )}
                            />
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <div className="rounded-3xl border border-white/20 bg-white/40 p-6 shadow-xl backdrop-blur-xl md:p-8 dark:border-white/5 dark:bg-neutral-900/40">
                            ...
                            {/* Title */}
                            <h2 className="mb-4 text-2xl font-bold text-neutral-900 md:text-3xl dark:text-white">
                                {notification.title}
                            </h2>
                            ...
                            <div className="mb-6 flex flex-wrap items-center gap-4 border-b border-neutral-200/50 pb-6 text-sm text-neutral-500 dark:border-white/5 dark:text-neutral-400">
                                ...
                                {notification.read_at && (
                                    <div className="flex items-center gap-2">
                                        ...
                                        Dibaca{' '}
                                        {getTimeAgo(notification.read_at)}
                                    </div>
                                )}
                            </div>
                            ...
                            {/* Message */}
                            <div className="mb-6">
                                <p className="text-lg leading-relaxed whitespace-pre-wrap text-neutral-700 dark:text-neutral-300">
                                    {notification.message}
                                </p>
                            </div>
                            ...
                            {notification.metadata &&
                                Object.keys(notification.metadata).length >
                                    0 && (
                                    <div className="mt-6 border-t border-neutral-200/50 pt-6 dark:border-white/5">
                                        ...
                                        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                                            {Object.entries(
                                                ...
                                                <div
                                                    key={key}
                                                    className="rounded-xl bg-neutral-50/80 p-3 dark:bg-neutral-800/50"
                                                >
