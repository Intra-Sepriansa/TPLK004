...
function CountdownTimer({ targetDate }: { targetDate: Date }) {
    ...
    return (
        <div className="flex items-center gap-1 font-mono">
            <span className="rounded bg-neutral-900 px-2 py-1 text-sm text-white dark:bg-white dark:text-neutral-900">
    ...
    const pieData = [
        {
            name: 'Hadir',
            value:
                chartData.distribution.find((d) => d.label === 'Hadir')
                    ?.value || 0,
            color: '#10b981',
        },
        {
            name: 'Terlambat',
            value:
                chartData.distribution.find((d) => d.label === 'Terlambat')
                    ?.value || 0,
            color: '#f59e0b',
        },
        {
            name: 'Tidak Hadir',
            value:
                chartData.distribution.find((d) => d.label === 'Tidak Hadir')
                    ?.value || 0,
            color: '#f43f5e',
        },
    ].filter((d) => d.value > 0);
            ...
            >
                        ...
                        <div className="flex flex-wrap items-start justify-between gap-6">
                            <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:gap-6 sm:text-left">
                                ...
                                <div className="mt-1 flex-1 sm:mt-0">
                                    ...
                                    >
                                        Pantau kehadiran, capaian, dan progress
                                        studi Anda di satu tempat.
                                    </motion.p>
                                </div>
                            </div>
                            ...
                            {nextSession ? (
                                <div className="space-y-3">
                                    <div className="rounded-2xl bg-gradient-to-br from-indigo-50/80 to-purple-50/80 p-4 backdrop-blur dark:from-indigo-900/20 dark:to-purple-900/20">
                                        ...
                                        <p className="text-sm text-neutral-500">
                                            {nextSession.title} — Pertemuan{' '}
                                            {nextSession.meeting_number}
                                        </p>
                                    ...
                                    {upcomingSessions
                                        ...
                                        .map((session) => (
                                            <div
                                                key={session.id}
                                                className="flex items-center gap-3 rounded-xl bg-neutral-50/50 p-2 backdrop-blur dark:bg-neutral-800/50"
                                            >
                                                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-neutral-100 text-neutral-500 dark:bg-neutral-800">
                                ...
                                {[
                                    ...
                                    <Link key={item.href} href={item.href}>
                                        <motion.div
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            className="flex cursor-pointer items-center gap-3 rounded-xl p-3 transition-colors hover:bg-neutral-100/60 dark:hover:bg-neutral-700/50"
                                        >
                                            <div
                ...
                >
                    ...
                    >
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            {(achievements.length > 0
                                ...
                                : [
                                      ...
                                      {
                                          type: 'early' as const,
                                          unlocked: stats.onTimeRate >= 90,
                                      },
                                      {
                                          type: 'consistent' as const,
                                          unlocked: stats.attendanceRate >= 80,
                                      },
                                      {
                                ...
                                .map((achievement, i) => (
                                    <motion.div
                                        ...
                                        whileHover={{
                                            scale: achievement.unlocked
                                                ? 1.15
                                                : 1.05,
                                            y: -5,
                                        }}
                                        className={cn(
                                            'flex cursor-pointer flex-col items-center rounded-xl bg-neutral-50/50 p-3 backdrop-blur transition-all dark:bg-neutral-800/50',
                        ...
                        <Link href="/user/achievements" className="mt-4 block">
                            <motion.div
                ...
                >
                    <div className="mb-6 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-neutral-500">
                                Target dan pencapaian semester ini
                            </p>
                        </div>
                    </div>
