...
const BadgeImage = ({
    ...
    return (
        <div
            className={cn(sizeClasses[size], 'group relative cursor-pointer')}
        ...
        >
            <img
                ...
                className={cn(
                    ...
                    !unlocked && 'opacity-40 blur-[2px] grayscale',
                    !unlocked &&
                        isHovered &&
                    ...
                    <div className="relative z-20">
                        <Link href="/user/achievements">
                            <motion.button
                                whileHover={{ x: -4 }}
                                whileTap={{ scale: 0.98 }}
                                className="mb-4 flex items-center gap-2 text-sm font-medium text-indigo-100 transition-colors hover:text-white"
                            >
                        ...
                        <div className="flex flex-col items-center gap-4 text-center sm:flex-row sm:items-start sm:gap-6 sm:text-left">
                            ...
                            <div className="mt-1 w-full flex-1 sm:mt-0">
                                <motion.p
                                    ...
                                    className="text-sm font-medium tracking-wide text-indigo-100 uppercase"
                                >
                                    {badge.category}
                                </motion.p>
                                <motion.h1
                                    ...
                                    className="mt-1 text-xl leading-tight font-bold sm:text-3xl"
                                >
                    ...
                    <div className="grid grid-cols-3 gap-2 md:gap-4">
                        {levels.map((level, index) => (
                            <motion.button
                                ...
                                className={cn(
                                    'relative rounded-2xl border border-white/20 bg-white/40 p-2 shadow-lg backdrop-blur-xl transition-all duration-300 md:p-4 dark:border-white/5 dark:bg-neutral-900/40',
                            ...
                            >
                                <div className="flex flex-col items-center gap-1.5 md:gap-3">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="mt-0.5 text-[10px] text-neutral-500 md:text-xs dark:text-neutral-400">
                                            <AnimatedCounter
                                                value={level.requirementValue}
                                            />{' '}
                                            target
                                        </p>
                                    </div>
                ...
                >
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            ...
                            >
                                <AnimatedCounter value={progress.current} /> /{' '}
                                <AnimatedCounter value={progress.target} />
                            </span>
                        </motion.div>
                        ...
                        >
                            ...
                            <motion.div
                                initial={{ left: 0 }}
                                animate={{
                                    left: `${Math.min(progress.percentage, 100)}%`,
                                }}
                                transition={{
                                    duration: 1,
                                    delay: 0.7,
                            ...
                            >
                                <motion.div
                                    ...
                                    className={cn(
                                        '-ml-3 flex h-6 w-6 items-center justify-center rounded-full shadow-lg',
                    ...
                    <ul className="grid gap-3 sm:grid-cols-2">
                        {tips.map((tip, index) => (
                            <motion.li
                                ...
                                className="flex cursor-pointer items-start gap-3 rounded-xl border border-white/20 bg-white/60 p-3 dark:border-white/5 dark:bg-neutral-900/40"
                            >
                                <motion.div
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 md:gap-4">
                            {relatedBadges.map((related, index) => (
                                <motion.button
                                    ...
                                    onClick={() =>
                                        router.visit(
                                            `/user/achievements/${related.type}`,
                                        )
                                    }
