...
export default function StudentProfile() {
    ...
    const stats = (props as unknown as PageProps).stats ?? { totalAttendance: 0, attendanceRate: 0, currentStreak: 0 };
    ...
    const profileForm = useForm({ nama: mahasiswa.nama ?? '' });
                            ...
                            <form onSubmit={handleProfileSubmit} className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input id="nama" value={profileForm.data.nama} onChange={e => profileForm.setData('nama', e.target.value)} className="pl-10" placeholder="Nama lengkap" />
                                    </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="rounded-2xl border border-slate-200/70 bg-gradient-to-br from-slate-900 to-slate-800 p-6 text-white shadow-sm dark:from-slate-800 dark:to-slate-900">
                                ...
                                <div className="flex items-end gap-2">
                                    <span className="text-4xl font-bold"><AnimatedCounter value={stats.attendanceRate} suffix="%" /></span>
                                    <span className="text-slate-400 mb-1">rata-rata</span>
                                </div>
                                <Progress value={stats.attendanceRate} className="mt-4 h-2 bg-slate-700" />
                                <p className="text-xs text-slate-400 mt-2">{stats.totalAttendance} total kehadiran • {stats.currentStreak} hari streak</p>
                            </div>
                        </div>
                    </div>
                )}
                    ...
                    <div className="grid gap-6 lg:grid-cols-2">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="rounded-2xl border border-slate-200/70 bg-gradient-to-br from-emerald-500 to-teal-600 p-6 text-white shadow-sm">
                                ...
                                <p className="text-sm text-emerald-100">Pertimbangkan untuk mengubah password secara berkala untuk keamanan optimal.</p>
                            </div>
                        </div>
                    </div>
                )}
