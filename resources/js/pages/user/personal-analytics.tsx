                    ...
                    <div className="relative">
                        <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:gap-6 sm:text-left">
                            ...
                            <div className="mt-1 flex-1 sm:mt-0">
                                ...
                                >
                                    Pantau perkembangan akademik kamu secara
                                    real-time.
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-0.5 text-xs text-neutral-500 sm:text-sm dark:text-neutral-400">
                                    {activityGraph.totalActivities} aktivitas
                                    sejak 1 Januari {activityGraph.year}
                                </p>
                            </div>
                        </div>
                    </div>

                    <div className="custom-scrollbar overflow-x-auto p-4 sm:p-6">
                        <div className="min-w-max pb-2">
                            <div className="mb-2 ml-8 flex text-[10px] text-neutral-500 sm:text-xs dark:text-neutral-400">
                                {(() => {
                                    ...
                                    if (monthPositions.length > 0) {
                                        monthPositions[
                                            monthPositions.length - 1
                                        ].span =
                                            activityGraph.weeks.length -
                                            monthPositions[
                                                monthPositions.length - 1
                                            ].startWeek;
                                    }

                                    return monthPositions.map(
                                        (month, index) => (
                                            <div
                                                key={index}
                                                style={{
                        ...
                        <div className="mt-4 flex items-center justify-end gap-2 text-xs text-neutral-500 dark:text-neutral-400">
                            ...
                            <div className="flex gap-[3px]">
                                {[0, 1, 2, 3, 4].map((level) => (
                                    <div
                                        key={level}
                                        className={`h-[11px] w-[11px] rounded-[2px] ${getActivityColor(level)}`}
                                    />
                                ))}
                            </div>
                            <span>Banyak</span>
                    ...
                    >
                        ...
                        <div className="space-y-4 p-6">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="font-bold text-neutral-900 dark:text-white">
                                    <AnimatedCounter
                                        value={comparison.class_average}
                                        suffix="%"
                                        decimals={1}
                                    />
                                </span>
                                ...
                                >
                                    <div className="mb-2 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                        ...
                                        <div className="text-left sm:text-right">
                                            ...
                                            {!course.can_take_uas && (
                                                <p className="mt-1 flex items-center gap-1 text-xs text-red-600 sm:justify-end dark:text-red-400">
                            ...
                            {badges.length > 0 ? (
                                ...
                                <div className="py-8 text-center">
                                    ...
                                    <p className="text-xs text-neutral-400 dark:text-neutral-500">
                                        Tingkatkan aktivitas untuk mendapatkan
                                        badge.
                                    </p>
                                </div>
                            )}
