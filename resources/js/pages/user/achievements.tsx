                ...
                >
                    ...
                    <div className="absolute inset-0 overflow-hidden">
                        ...
                        <motion.div
                            ...
                            className="absolute top-1/2 right-1/4 h-32 w-32 rounded-full bg-white/5"
                        />
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between flex-wrap gap-4">
                            <div className="flex items-center gap-4">
                                <motion.div
                                    ...
                                    className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white/20 backdrop-blur-sm shadow-xl ring-2 ring-white/30"
                                >
                                ...
                                <div>
                                    <motion.p
                                        ...
                                        className="text-sm text-amber-100 font-medium tracking-wide"
                                    >
                                        🎮 Gamification
                                    </motion.p>
                                    <motion.h1
                        ...
                        <motion.p
                            ...
                            className="mt-4 text-amber-100 text-lg"
                        >
                        ...
                        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                            {[
                                ...
                                <motion.div
                                    ...
                                    className="group bg-white/10 backdrop-blur-sm rounded-xl p-3 md:p-4 cursor-pointer ring-1 ring-white/10"
                                >
                        ...
                        <div className="flex-1 min-w-[280px]">
                            <div className="flex items-center gap-4 mb-4">
                                <motion.div
                                    ...
                                    whileHover={{ scale: 1.1, rotate: 360 }}
                                    className={cn(
                                        "flex h-16 w-16 items-center justify-center rounded-2xl text-2xl font-bold shadow-lg cursor-pointer",
                            ...
                            >
                                ...
                                <p className="text-xs text-slate-500">
                                    <AnimatedCounter value={Math.round(nextLevelPoints - (totalPoints % nextLevelPoints))} /> poin lagi untuk naik level ⬆️
                                </p>
                            </motion.div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                                <motion.div
                                    ...
                                    className="p-2.5 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 text-white shadow-lg shadow-amber-500/30"
                                >
                            ...
                            <motion.div
                                ...
                                animate={{ opacity: 1, scale: 1 }}
                                transition={{ delay: 0.8 }}
                                className="flex items-center gap-1 p-1 bg-slate-100 dark:bg-gray-800 rounded-lg"
                            >
                                {[
                                ...
                                {filteredAchievements.map((achievement, index) => {
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            className={cn(
                                                'rounded-2xl border-2 p-4 cursor-pointer relative overflow-hidden group',
                                                isUnlocked
                                                    ? 'border-amber-300 bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:border-amber-700 dark:from-amber-950/40 dark:via-orange-950/30 dark:to-yellow-950/20 shadow-lg'
                                                    : 'border-slate-200 bg-slate-50/80 dark:border-gray-700 dark:bg-gray-900/50'
                                            )}
                                        >
                                                    ...
                                                    {isHovered && (
                                                        <div className="absolute inset-0 pointer-events-none overflow-hidden">
                                                            {[...Array(4)].map((_, i) => (
                                                                ...
                                                                >
                                                                    <Sparkles className="text-amber-400/60" size={10} />
                                                                </motion.div>
                                                            ))}
                                                        </div>
                                                    )}
                                                ...
                                                <div className="flex items-start justify-between mb-3">
                                                    ...
                                                    <div className="flex flex-col items-end gap-1.5">
                                                        ...
                                                        <motion.div
                                                            ...
                                                            className="flex items-center gap-1 px-2 py-1 rounded-full bg-slate-100 text-slate-600 text-xs font-medium dark:bg-gray-800 dark:text-slate-400"
                                                        >
                ...
                >
                    <div className="flex items-center gap-3 mb-5">
                        <motion.div
                            ...
                            whileHover={{ rotate: 360 }}
                            className="p-2.5 rounded-xl bg-gradient-to-br from-yellow-400 to-amber-500 text-white shadow-lg shadow-amber-500/30"
                        >
                    ...
                    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                        {[
                            ...
                            <motion.div
                                ...
                                className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 dark:bg-gray-800/50 cursor-pointer group"
                            >
                                <motion.div
                                    whileHover={{ 
                                        scale: 1.1,
