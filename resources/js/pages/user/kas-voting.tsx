...
export default function KasVoting({ votings, stats, filters }: Props) {
    ...
    const approvalRate =
        totalVotings > 0
            ? Math.round((stats.approved / totalVotings) * 100)
            : 0;
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
                            <div className="flex flex-col items-center gap-4 text-center sm:flex-row sm:items-start sm:gap-6 sm:text-left">
                                ...
                                <div className="mt-1 w-full flex-1 sm:mt-0">
                                    ...
                                    >
                                        Usulkan dan vote pengeluaran kas secara
                                        demokratis bersama teman sekelas.
                                    </motion.p>
                                </div>
                            </div>
                            ...
                            >
                                <Button
                                    onClick={() =>
                                        router.visit('/user/kas-voting/create')
                                    }
                                    className="inline-flex h-11 w-auto items-center rounded-2xl border border-white/20 bg-white/20 px-5 font-semibold whitespace-nowrap text-white shadow-lg backdrop-blur-xl transition-all hover:bg-white/30"
                                >
                                    <Plus className="mr-2 h-4 w-4" /> Usulkan
                                    Pengeluaran
                                </Button>
                            </motion.div>
                        </div>
                ...
                >
                    {[
                        ...
                        },
                        {
                            ...
                            progress:
                                totalVotings > 0
                                    ? (stats.approved / totalVotings) * 100
                                    : 0,
                        ...
                        },
                        {
                            ...
                            progress:
                                totalVotings > 0
                                    ? (stats.rejected / totalVotings) * 100
                                    : 0,
                        ...
                        >
                            ...
                            />
                            <motion.div
                                className={`absolute -top-6 -right-6 h-24 w-24 rounded-full ${stat.glow} opacity-20 blur-2xl transition-all duration-500 group-hover:scale-150 group-hover:opacity-40`}
                            />
                            ...
                            <div className="relative flex flex-col gap-3">
                                <div className="relative flex flex-col items-center gap-3 sm:flex-row sm:items-start">
                                    ...
                                    >
                                        <div
                                            className={`absolute inset-0 ${stat.cropImage ? 'overflow-hidden rounded-xl' : ''}`}
                                        >
                                            <img
                                                src={stat.image}
                                                alt={stat.label}
                                    ...
                                    <div className="flex-1 text-center sm:text-left">
                                        <p className="text-xs leading-tight font-medium text-neutral-500 sm:text-sm dark:text-neutral-400">
                                            {stat.label}
                                        </p>
                                        <div className="mt-1 text-xl font-bold text-neutral-900 sm:text-2xl dark:text-white">
                                            <AnimatedCounter
                                                value={stat.value}
                        ...
                        <div className="mb-6 flex gap-2 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                            {[
                                ...
                                <motion.button
                                    ...
                                    className={`inline-flex items-center rounded-xl px-3 py-2 text-xs font-medium whitespace-nowrap transition-all sm:px-4 sm:py-2.5 sm:text-sm ${
                                ...
                                >
                                    ...
                                    <span
                                        className={`ml-1 rounded-full px-1.5 py-0.5 text-[10px] sm:text-xs ${
                                            filters.status === tab.value
                                                ? 'bg-white/20'
                            ...
                            {votings.length > 0 ? (
                                                ...
                                                >
                                                    <div className="mb-3 flex items-start justify-between gap-3">
                                                        <div className="flex flex-wrap items-center gap-2">
                                                            <span
                                                                className={`inline-flex items-center gap-1 rounded-lg px-2 py-1 text-[10px] font-semibold sm:px-2.5 sm:text-xs ${statusConfig.badgeClass}`}
                                                            >
                                                            ...
                                                            <span
                                                                className={`inline-flex items-center gap-1 rounded-lg px-2 py-1 text-[10px] font-medium sm:px-2.5 sm:text-xs ${categoryConfig.color}`}
                                                            >
                                ...
                                >
                                    ...
                                    <p className="mt-1 text-sm text-neutral-400 dark:text-neutral-500">
                                        Jadilah yang pertama mengusulkan
                                        pengeluaran kas!
                                    </p>
                                    <Button
                                        onClick={() =>
                                            router.visit(
                                                '/user/kas-voting/create',
                                            )
                                        }
                                        className="mt-4 inline-flex h-11 w-auto items-center rounded-2xl border border-white/20 bg-gradient-to-r from-indigo-500 to-purple-600 px-5 font-semibold whitespace-nowrap shadow-lg shadow-purple-500/30"
                                    >
