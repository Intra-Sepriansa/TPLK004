    ...
    izin: [
        {
            ...
            emoji: '👨‍👩‍👧',
            content:
                'Saya izin tidak mengikuti perkuliahan karena ada keperluan keluarga yang tidak dapat ditinggalkan. Saya akan mengejar materi yang tertinggal setelah sesi berakhir.',
        },
        {
            id: 'izin-acara',
            title: 'Acara Resmi',
            emoji: '🎓',
            content:
                'Saya memohon izin tidak hadir karena mengikuti acara resmi pada waktu yang bersamaan. Bukti kegiatan akan saya lampirkan dan saya siap mengikuti arahan dosen terkait materi pengganti.',
        },
        {
            id: 'izin-transport',
            ...
            emoji: '🚗',
            content:
                'Saya memohon izin tidak hadir karena kendala transportasi mendadak sehingga tidak dapat tiba di kampus tepat waktu. Saya akan mempelajari materi perkuliahan secara mandiri.',
        },
        {
            id: 'izin-wawancara',
            ...
            emoji: '💼',
            content:
                'Saya memohon izin tidak mengikuti perkuliahan karena menghadiri wawancara/seleksi yang waktunya bersamaan. Saya akan melengkapi materi kuliah setelah kegiatan selesai.',
        },
    ],
    sakit: [
        {
            ...
            emoji: '🤒',
            content:
                'Saya tidak dapat mengikuti perkuliahan karena sedang mengalami demam/flu dan perlu beristirahat sesuai anjuran. Saya akan mengirimkan surat keterangan jika diperlukan.',
        },
        {
            id: 'sakit-dokter',
            ...
            emoji: '🏥',
            content:
                'Saya memohon izin tidak hadir karena harus menjalani pemeriksaan dan perawatan dokter pada jam perkuliahan. Surat keterangan akan saya lampirkan sebagai bukti pendukung.',
        },
        {
            id: 'sakit-rawat',
            ...
            emoji: '💊',
            content:
                'Kondisi kesehatan saya saat ini belum memungkinkan untuk mengikuti perkuliahan. Saya membutuhkan waktu istirahat agar dapat kembali mengikuti kelas dengan optimal.',
        },
        {
            id: 'sakit-migrain',
            ...
            emoji: '🧠',
            content:
                'Saya izin tidak hadir karena mengalami migrain/sakit kepala berat sehingga tidak dapat berkonsentrasi di kelas. Saya akan mengejar materi setelah kondisi membaik.',
        },
    ],
};
...
export default function Permit({
    ...
    const [activeSection, setActiveSection] = useState<'history' | 'analytics'>(
        'history',
    );
    ...
    const [openDiscussionId, setOpenDiscussionId] = useState<number | null>(
        null,
    );
    ...
    const toneScore = useMemo(() => {
        ...
        const informalCount = informalMarkers.reduce(
            (acc, keyword) => acc + (text.includes(keyword) ? 1 : 0),
            0,
        );
    ...
    const grammarSuggestions = useMemo(() => {
        ...
        if (text.trim() && text.trim().length < 30) {
            suggestions.push({
                id: 'short',
                message:
                    'Alasan terlalu singkat. Tambahkan konteks agar dosen mudah memverifikasi.',
        ...
        const replacements: Array<[RegExp, string, string]> = [
            [
                /\bgk\b|\bgak\b|\bga\b/gi,
                'Gunakan "tidak" agar lebih formal.',
                text.replace(/\bgk\b|\bgak\b|\bga\b/gi, 'tidak'),
            ],
            [
                /\bkrn\b/gi,
                'Gunakan "karena" agar kalimat lebih jelas.',
                text.replace(/\bkrn\b/gi, 'karena'),
            ],
            [
                /\bizin ya\b/gi,
                'Gunakan kalimat permohonan resmi.',
                text.replace(/\bizin ya\b/gi, 'saya memohon izin'),
            ],
        ];
    ...
    const monthlyData = useMemo(() => {
        ...
        const grouped = new Map<
            string,
            { month: string; izin: number; sakit: number }
        >();
        ...
        permits.forEach((permit) => {
            ...
            const monthIndex = monthName.findIndex(
    ...
    const improveReason = () => {
        ...
        if (
            !improved.toLowerCase().includes('mohon') &&
            !improved.toLowerCase().includes('izin')
        ) {
        ...
        if (!improved.toLowerCase().includes('materi')) {
            improved +=
                ' Saya akan mengejar materi yang tertinggal setelah kondisi memungkinkan.';
        }
    ...
    return (
        <StudentLayout>
            ...
            >
                        ...
                        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row sm:items-start sm:gap-6">
                            <div className="flex w-full flex-col items-center gap-5 text-center sm:w-auto sm:flex-row sm:gap-6 sm:text-left">
                                ...
                                <div className="mt-1 flex-1 sm:mt-0">
                                    ...
                                    >
                                        Ajukan izin atau sakit dengan upload
                            ...
                            <motion.div
                                className="mt-2 flex w-full justify-center sm:mt-0 sm:w-auto sm:justify-end"
                            ...
                            >
                                <Button
                                    onClick={() =>
                                        router.visit('/user/permit/create')
                                    }
                    ...
                    {[
                        {
                            ...
                            glow: 'bg-indigo-500',
                            gradientBg:
                                'from-indigo-500/5 to-indigo-500/5 dark:from-indigo-500/10 dark:to-indigo-500/10',
                        },
                        {
                            key: 'pending',
                            title: 'Menunggu',
                            ...
                            glow: 'bg-yellow-500',
                            gradientBg:
                                'from-yellow-500/5 to-yellow-500/5 dark:from-yellow-500/10 dark:to-yellow-500/10',
                        },
                        {
                            key: 'approved',
                            title: 'Disetujui',
                        ...
                        },
                        {
                            ...
                            glow: 'bg-red-500',
                            gradientBg:
                                'from-red-500/5 to-red-500/5 dark:from-red-500/10 dark:to-red-500/10',
                        },
                    ].map((stat) => (
                        <motion.div
                            key={stat.key}
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                animate={{
                                    ...
                                    opacity:
                                        hoveredCard === stat.key ? 0.4 : 0.2,
                                }}
                                transition={{ duration: 0.5 }}
                                className={`absolute -top-10 -right-10 h-32 w-32 rounded-full ${stat.glow} blur-3xl`}
                            />
                ...
                >
                    <div className="border-b border-white/10 p-6 dark:border-white/5">
                        <div className="flex items-center gap-2">
                            <div className="rounded-lg bg-gradient-to-br from-indigo-400 to-purple-600 p-2 text-white">
                            ...
                            <button
                                ...
                                className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold transition-all ${
                                    activeSection === 'history'
                                        ...
                                        : 'bg-white/60 text-neutral-700 hover:bg-white/80 dark:bg-neutral-800/60 dark:text-neutral-300 dark:hover:bg-neutral-800/80'
                                }`}
                            >
                                <FileText className="h-4 w-4" />
                                Riwayat
                        ...
                        {activeSection === 'history' ? (
                            <>
                                ...
                                {permits.length > 0 ? (
                                    <div className="space-y-4">
                                        {permits.map((permit) => {
                                            const statusConfig =
                                                getStatusConfig(permit.status);
                                            const StatusIcon =
                                                statusConfig.icon;
                                            const isDiscussionOpen =
                                                openDiscussionId === permit.id;
                                            ...
                                            return (
                                                <motion.div
                                                    ...
                                                    className={`rounded-2xl border-2 bg-white/60 p-5 backdrop-blur-xl transition-all hover:shadow-lg dark:bg-neutral-900/60 ${
                                                        permit.status ===
                                                        'pending'
                                                    ...
                                                    <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                                        <div className="flex-1">
                                                            <div className="mb-3 flex flex-wrap items-center gap-2">
                                                                <span
                                                                    className={`inline-flex items-center gap-1.5 rounded-xl px-3 py-1.5 text-xs font-semibold ${statusConfig.bg} ${statusConfig.text}`}
                                                                >
                                                            ...
                                                            <p className="mt-3 rounded-xl border border-white/20 bg-white/60 p-3 text-sm text-neutral-700 dark:border-white/5 dark:bg-neutral-800/60 dark:text-neutral-300">
                                                                {permit.reason}
                                                            </p>
                                                            ...
                                                            {permit.status ===
                                                                ...
                                                                permit.rejection_reason && (
                                                                    <div className="mt-3 rounded-xl border border-red-200 bg-red-50 p-3 dark:border-red-800 dark:bg-red-900/20">
                                                            ...
                                                            <div className="mt-4 grid grid-cols-1 gap-2 md:grid-cols-3">
                                                                <div className="rounded-xl border border-white/20 bg-white/60 p-2.5 dark:border-white/5 dark:bg-neutral-800/60">
                                                            ...
                                                            <AnimatePresence>
                                                                {isDiscussionOpen && (
                                                                    <motion.div
                                                                        ...
                                                                        className="mt-3 rounded-2xl border border-white/20 bg-white/60 p-3 dark:border-white/5 dark:bg-neutral-800/60"
                                                                    >
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            className={`rounded-xl p-2.5 text-sm ${
                                                                                                comment.is_mine
                                                                                                    ...
                                                                                                    : 'mr-6 border border-white/20 bg-white/70 text-neutral-700 dark:border-white/5 dark:bg-neutral-900/70 dark:text-neutral-200'
                                                                                            }`}
                                                                                        >
                                                                                            <div className="mb-1 flex items-center justify-between gap-2">
                                                                                                <p
                                                                                                    className={`text-xs font-semibold ${comment.is_mine ? 'text-indigo-100' : 'text-neutral-500 dark:text-neutral-400'}`}
                                                                                                >
                                                                                                    {
                                                                                                        comment.sender_name
                                                                                                    }
                                                                        ...
                                                                        <div className="mt-3 flex gap-2">
                                                                            <Textarea
                                                                                ...
                                                                                className="border-white/20 bg-white/70 dark:border-white/5 dark:bg-neutral-900/70"
                                                                            />
                                                                            <Button
                                                                                size="sm"
                                                        ...
                                                        <div className="flex gap-2">
                                                            {permit.attachment && (
                                                                <Button
                                                                    ...
                                                                    onClick={() =>
                                                                        router.visit(
                                                                            `/user/permit/${permit.id}/attachment`,
                                                                        )
                                                                    }
                                    ...
                                    <div className="py-16 text-center">
                                        <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-teal-100 to-cyan-100 dark:from-teal-900/30 dark:to-cyan-900/30">
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
                                    <div className="rounded-2xl border border-blue-200/50 bg-blue-50/70 p-4 dark:border-blue-800/40 dark:bg-blue-900/20">
                                        <p className="text-xs font-semibold text-blue-600 dark:text-blue-300">
                                            Approval Rate
                                        </p>
                                        <p className="mt-1 text-2xl font-extrabold text-blue-700 dark:text-blue-200">
                                            {approvalRate}%
                                        </p>
                                        <p className="mt-1 text-xs text-blue-500">
                                            Dari total {stats.total} pengajuan
                                        </p>
                                    </div>
                                    <div className="rounded-2xl border border-emerald-200/50 bg-emerald-50/70 p-4 dark:border-emerald-800/40 dark:bg-emerald-900/20">
                                        ...
                                        <p className="mt-1 text-xs text-emerald-500">
                                            Perlu lampiran medis untuk validasi
                                        </p>
                                    </div>
                                    <div className="rounded-2xl border border-amber-200/50 bg-amber-50/70 p-4 dark:border-amber-800/40 dark:bg-amber-900/20">
                                        ...
                                        <p className="mt-1 text-xs text-amber-500">
                                            Ajak dosen diskusi di tiap card
                                        </p>
                                    </div>
                                </div>

                                <div className="rounded-2xl border border-white/20 bg-white/60 p-4 backdrop-blur-xl dark:border-white/5 dark:bg-neutral-900/60">
                                    <h4 className="mb-3 text-sm font-bold text-neutral-800 dark:text-neutral-200">
                                        Trend Pengajuan (6 data terakhir)
                                    </h4>
                                    <div className="space-y-3">
                                        {monthlyData.length > 0 ? (
                                            monthlyData.map((item) => {
                                                ...
                                                const izinWidth = total
                                                    ? (item.izin / total) * 100
                                                    : 0;
                                                const sakitWidth = total
                                                    ? (item.sakit / total) * 100
                                                    : 0;

                                                return (
                                                    <div
                                                        key={`${item.month}-${item.izin}-${item.sakit}`}
                                                        className="space-y-1"
                                                    >
                                ...
                                <div className="rounded-2xl border border-purple-200/50 bg-purple-50/70 p-4 dark:border-purple-800/40 dark:bg-purple-900/20">
                                    ...
                                    <ul className="space-y-2 text-xs text-purple-700 dark:text-purple-200">
                                        <li>
                                            • Approval rate kamu saat ini{' '}
                                            <strong>{approvalRate}%</strong>.
                                            Gunakan alasan yang jelas dan
                                            lampiran agar cepat diproses.
                                        </li>
                                        <li>
                                            • Selalu cek status timeline:{' '}
                                            <strong>
                                                Diajukan → Dibaca Dosen →
                                                Keputusan
                                            </strong>
                                            .
                                        </li>
                                        <li>
                                            • Gunakan fitur diskusi untuk
                                            klarifikasi langsung ke dosen tanpa
                                            harus menunggu ditolak.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                {showForm && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative flex max-h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-3xl border border-white/20 bg-white/40 p-8 shadow-2xl backdrop-blur-xl dark:border-white/5 dark:bg-neutral-900/40"
                            style={{
                        ...
                        >
                            ...
                            <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-3xl">
                                <motion.div
                                    ...
                                    className="absolute -top-20 -right-20 h-64 w-64 rounded-full bg-gradient-to-br from-teal-400 to-cyan-500 blur-3xl"
                                />
                                <motion.div
                                    animate={{
                                        scale: [1, 1.4, 1],
                                    ...
                                    className="absolute -bottom-20 -left-20 h-72 w-72 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 blur-3xl"
                                />
                            </div>
                            ...
                            <div className="relative mb-8 flex items-start justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        >
                                            Isi form berikut dengan lengkap dan
                                            jelas
                                        </motion.p>
                                    </div>
                                </div>
                                <motion.button
                                    ...
                                    className="group rounded-xl p-3 transition-all hover:bg-white/60 dark:hover:bg-neutral-800/70"
                                >
                                    <X className="h-5 w-5 text-neutral-400 transition-colors group-hover:text-neutral-600 dark:group-hover:text-neutral-200" />
                                </motion.button>
                            </div>
                            ...
                            <form
                                ...
                                className="scrollbar-thin scrollbar-thumb-teal-500 scrollbar-track-neutral-200 dark:scrollbar-track-neutral-800 flex-1 space-y-6 overflow-y-auto pr-2"
                            >
                                    ...
                                    {formStep === 1 && (
                                        ...
                                        >
                                            ...
                                            <motion.div
                                                ...
                                                className="mb-6 rounded-2xl border-2 border-teal-200/50 bg-gradient-to-br from-teal-50 to-cyan-50 p-6 text-center dark:border-teal-800/50 dark:from-teal-950/30 dark:to-cyan-950/30"
                                            >
                                                <motion.div
                                                    animate={{
                                                        scale: [1, 1.1, 1],
                                                ...
                                                <h3 className="mb-2 text-xl font-bold text-teal-700 dark:text-teal-300">
                                                    Pilih Sesi Perkuliahan
                                                </h3>
                                                <p className="text-sm text-teal-600 dark:text-teal-400">
                                                    Pilih sesi yang ingin kamu
                                                    ajukan izin/sakit
                                                </p>
                                            </motion.div>
                                            ...
                                            >
                                                ...
                                                >
                                                    <SelectTrigger className="h-14 rounded-xl border-2 border-white/20 bg-white/70 shadow-sm transition-all hover:border-teal-400 hover:shadow-md focus:border-teal-500 dark:border-white/10 dark:bg-neutral-800/70">
                                                ...
                                                <AnimatePresence>
                                                    {errors.attendance_session_id && (
                                                        <motion.p
                                                            ...
                                                            className="flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-600 dark:border-red-800 dark:bg-red-950/30 dark:text-red-400"
                                                        >
                                                        ...
                                                        <motion.button
                                                            ...
                                                            className={`group relative overflow-hidden rounded-2xl border-2 p-6 transition-all duration-300 ${
                                                                ...
                                                                type.value
                                                                    ? type.color ===
                                                                      'blue'
                                                                        ? 'border-blue-500 bg-gradient-to-br from-blue-50 to-blue-100 shadow-xl shadow-blue-500/20 dark:from-blue-950/50 dark:to-blue-900/30'
                                                                        : 'border-red-500 bg-gradient-to-br from-red-50 to-red-100 shadow-xl shadow-red-500/20 dark:from-red-950/50 dark:to-red-900/30'
                                                                    : 'border-white/20 bg-white/70 hover:border-teal-300 dark:border-white/10 dark:bg-neutral-800/70 dark:hover:border-teal-600'
                                                            }`}
                                                        >
                                                            ...
                                                            <div className="relative">
                                                                ...
                                                                >
                                                                    <type.icon
                                                                        className={`h-8 w-8 drop-shadow-[0_6px_10px_rgba(0,0,0,0.3)] ${
                                                                            data.type ===
                                                                            type.value
                                                                                ? type.color ===
                                                                                  'blue'
                                                                ...
                                                                <div className="text-center">
                                                                    <p className="mb-1 flex items-center justify-center gap-2 text-lg font-bold">
                                                                        <span>
                                                                            {
                                                                                type.emoji
                                                                            }
                                    ...
                                    {formStep === 2 && (
                                        ...
                                        >
                                            ...
                                            <motion.div
                                                ...
                                                className="mb-6 rounded-2xl border-2 border-purple-200/50 bg-gradient-to-br from-purple-50 to-pink-50 p-6 text-center dark:border-purple-800/50 dark:from-purple-950/30 dark:to-pink-950/30"
                                            >
                                                <motion.div
                                                    animate={{
                                                        scale: [1, 1.1, 1],
                                            ...
                                            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                                                ...
                                                >
                                                    ...
                                                    <div className="relative">
                                                        <Textarea
                                                            ...
                                                            rows={8}
                                                            maxLength={500}
                                                            className="resize-none rounded-xl border-2 border-white/20 bg-white/70 pr-12 shadow-sm transition-all hover:border-purple-400 focus:border-purple-500 focus:shadow-lg dark:border-white/10 dark:bg-neutral-800/70"
                                                        />
                                                        <motion.div
                                                            initial={{
                                                                scale: 0,
                                                    ...
                                                    <div className="rounded-2xl border-2 border-teal-200/50 bg-gradient-to-br from-teal-50 to-cyan-50 p-4 dark:border-teal-800/50 dark:from-teal-950/20 dark:to-cyan-950/20">
                                                        <p className="mb-2 text-sm font-semibold text-teal-700 dark:text-teal-300">
                                                            Tips Pengajuan:
                                                        </p>
                                                        <ul className="space-y-1.5 text-xs text-teal-600 dark:text-teal-400">
                                                            <li>
                                                                • Jelaskan
                                                                kondisi atau
                                                                situasi dengan
                                                ...
                                                <motion.div
                                                    ...
                                                    className="rounded-2xl border border-purple-200/60 bg-purple-50/60 p-4 dark:border-purple-800/40 dark:bg-purple-900/20"
                                                >
                                                    {showAiAssistant ? (
                                                        <div className="space-y-4">
                                                            <div className="flex items-center gap-2">
                                                                <Bot className="h-4 w-4 text-purple-600 dark:text-purple-300" />
                                                                <h4 className="text-sm font-bold text-purple-700 dark:text-purple-200">
                                                                    AI Writing
                                                                    Assistant
                                                                </h4>
                                                            </div>
                                                            ...
                                                            <div>
                                                                <p className="mb-2 text-xs font-semibold text-purple-600 dark:text-purple-300">
                                                                    Template
                                                                    Cepat
                                                                </p>
                                                                    ...
                                                                    {REASON_TEMPLATES[
                                                                        ...
                                                                        (
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                className="rounded-xl border border-purple-200 bg-white/70 p-2.5 text-left transition-colors hover:border-purple-400 dark:border-purple-800 dark:bg-neutral-900/70"
                                                                            >
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="h-2.5 overflow-hidden rounded-full bg-purple-100 dark:bg-purple-950">
                                                                    <div
                                                                        className="h-full bg-gradient-to-r from-amber-400 via-purple-500 to-emerald-500"
                                                                        style={{
                                                                            width: `${toneScore}%`,
                                                                        }}
                                                                    />
                                                                        ...
                                                                        grammarSuggestions.map(
                                                                            (
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    className="rounded-lg border border-purple-200 bg-white/70 p-2 dark:border-purple-800 dark:bg-neutral-900/70"
                                                                                >
                                                        ...
                                                        <div className="flex h-full items-center justify-center text-center">
                                                            <div>
                                                                <Sparkles className="mx-auto mb-2 h-7 w-7 text-purple-500" />
                                    ...
                                    {formStep === 3 && (
                                        ...
                                        >
                                            ...
                                            <motion.div
                                                ...
                                                className="mb-6 rounded-2xl border-2 border-blue-200/50 bg-gradient-to-br from-blue-50 to-indigo-50 p-6 text-center dark:border-blue-800/50 dark:from-blue-950/30 dark:to-indigo-950/30"
                                            >
                                                <motion.div
                                                    animate={{
                                                        y: [0, -10, 0],
                                            ...
                                            >
                                                ...
                                                <motion.div
                                                    ...
                                                    onDrop={handleDrop}
                                                    className={`relative overflow-hidden rounded-2xl border-2 border-dashed p-10 transition-all duration-300 ${
                                                        dragActive
                                                            ? 'border-blue-500 bg-gradient-to-br from-blue-50 to-indigo-50 shadow-xl shadow-blue-500/20 dark:from-blue-950/30 dark:to-indigo-950/30'
                                                            : 'border-white/20 bg-white/70 hover:border-blue-400 dark:border-white/10 dark:bg-neutral-800/70 dark:hover:border-blue-600'
                                                    }`}
                                                >
                                                    ...
                                                    <div className="relative text-center">
                                                        ...
                                                        <AnimatePresence mode="wait">
                                                            {data.attachment ? (
                                                                ...
                                                                >
                                                                    <p className="mb-2 flex items-center justify-center gap-2 text-base font-bold text-emerald-600 dark:text-emerald-400">
                                                                ...
                                                                >
                                                                    <p className="mb-2 text-base font-bold text-neutral-700 dark:text-neutral-300">
                                                                        {dragActive
                                                ...
                                                <AnimatePresence>
                                                    {data.attachment && (
                                                        <motion.div
                                                            ...
                                                            className="flex items-center gap-4 rounded-2xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 to-teal-50 p-5 shadow-lg dark:border-emerald-800 dark:from-emerald-950/30 dark:to-teal-950/30"
                                                        >
                                                            <motion.div
                                                                animate={{
                                                                    scale: [
                                                                ...
                                                                className="rounded-xl bg-gradient-to-br from-emerald-400 to-teal-500 p-4 shadow-lg shadow-emerald-500/30"
                                                            >
                                                                <FileCheck className="h-8 w-8 text-white" />
                                                            </motion.div>
                                                            <div className="min-w-0 flex-1">
                                                                <p className="mb-1 truncate text-base font-bold text-emerald-700 dark:text-emerald-300">
                                                                    {
                                                                        data
                                                                            .attachment
                                                                            .name
                                            ...
                                            <motion.div
                                                ...
                                                animate={{ opacity: 1, y: 0 }}
                                                transition={{ delay: 0.2 }}
                                                className="rounded-2xl border-2 border-amber-200/50 bg-gradient-to-br from-amber-50 to-orange-50 p-5 dark:border-amber-800/50 dark:from-amber-950/20 dark:to-orange-950/20"
                                            >
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    >
                                                        <Star className="mt-0.5 h-5 w-5 shrink-0 text-amber-600 dark:text-amber-400" />
                                                    </motion.div>
                                                    <div className="flex-1">
                                    ...
                                    {formStep < 3 ? (
                                        ...
                                        >
                                            <Button
                                                type="submit"
                                                disabled={processing}
                                                className="gap-2 rounded-xl bg-gradient-to-r from-teal-500 to-cyan-600 shadow-lg shadow-teal-500/30 hover:from-teal-600 hover:to-cyan-700"
                                            >
                                                {processing ? (
                                                    <>
                                                        <motion.div
