...
export default function ClassInsights({
    ...
    const [selectedCourseId, setSelectedCourseId] = useState<string>(
        selectedCourse ? String(selectedCourse.course_id) : '',
    );
    ...
    const handleExport = async (format: 'csv' | 'pdf' | 'excel' | 'json') => {
        ...
        try {
            ...
            const response = await fetch(
                `/dosen/class-insights/export-${format}`,
                {
                    method: 'POST',
                    headers: {
            ...
            toast.success(
                `Laporan berhasil diexport sebagai ${format.toUpperCase()}`,
            );
    ...
    const comparisonData = useMemo(() => {
        ...
        const maxSessions = Math.max(
            c1.attendance_by_session.length,
            c2.attendance_by_session.length,
        );
            ...
            >
                        ...
                        <div className="flex flex-col items-center justify-between gap-6 lg:flex-row lg:items-start">
                            <div className="flex w-full flex-col items-center gap-5 text-center sm:flex-row sm:gap-6 sm:text-left lg:w-auto">
                                ...
                                <div className="mt-1 flex-1 sm:mt-0">
                                    ...
                                    >
                                        Analisis kehadiran per kelas untuk{' '}
                                        {dosen.nama}
                                    </motion.p>
                                </div>
                            </div>
                            <div className="mt-4 flex w-full flex-col items-center gap-4 lg:mt-0 lg:w-auto lg:items-end">
                                {selectedCourse && (
                                    <motion.div
                                        ...
                                        className="flex w-full items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/20 px-6 py-3 shadow-lg backdrop-blur-xl sm:w-auto"
                                    >
                                        ...
                                        <div className="text-left">
                                            ...
                                            <div className="flex items-center gap-1 text-2xl font-bold text-white">
                                                <AnimatedCounter
                                                    value={
                                                        selectedCourse.average_attendance_rate
                                                    }
                                                />
                                                %
                                            </div>
                                ...
                                <motion.div
                                    ...
                                    className="flex w-full flex-wrap items-center justify-center gap-2 lg:justify-end"
                                >
                                    <motion.button
                                        whileHover={{ scale: 1.05 }}
                                        whileTap={{ scale: 0.95 }}
                                        onClick={handleRefresh}
                                        className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/10 px-4 py-2.5 text-sm font-semibold text-white backdrop-blur-md transition-all hover:bg-white/20"
                                    >
                                    ...
                                    <motion.button
                                        ...
                                        className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-500 to-fuchsia-500 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-violet-500/25 transition-all hover:from-violet-600 hover:to-fuchsia-600"
                                    >
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="group relative overflow-hidden rounded-3xl border border-white/20 bg-white/40 p-6 shadow-xl backdrop-blur-xl transition-all hover:shadow-blue-500/10 dark:border-white/5 dark:bg-neutral-900/40"
                    >
                        ...
                        <motion.div
                            animate={{
                                scale: hoveredCard === 'courses' ? 1.5 : 1,
                                opacity: hoveredCard === 'courses' ? 0.4 : 0.2,
                            }}
                            className="absolute -top-10 -right-10 h-32 w-32 rounded-full bg-blue-500 blur-3xl transition-all duration-500"
                        />
                    ...
                    <motion.div
                        ...
                        onHoverEnd={() => setHoveredCard(null)}
                        className="group relative overflow-hidden rounded-3xl border border-white/20 bg-white/40 p-6 shadow-xl backdrop-blur-xl transition-all hover:shadow-purple-500/10 dark:border-white/5 dark:bg-neutral-900/40"
                    >
                        ...
                        <motion.div
                            animate={{
                                scale: hoveredCard === 'average' ? 1.5 : 1,
                                opacity: hoveredCard === 'average' ? 0.4 : 0.2,
                            }}
                            className="absolute -top-10 -right-10 h-32 w-32 rounded-full bg-purple-500 blur-3xl transition-all duration-500"
                        />
                        <div className="relative flex items-center gap-4">
                            <motion.div
                                whileHover={{ scale: 1.1, rotate: 10 }}
                    ...
                    >
                        ...
                        <motion.div
                            animate={{
                                scale: hoveredCard === 'sessions' ? 1.5 : 1,
                                opacity: hoveredCard === 'sessions' ? 0.4 : 0.2,
                            }}
                ...
                >
                    <div className="mb-5 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-neutral-500">
                                Lihat analisis detail per kelas
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            <SelectTrigger className="border-2 py-6 focus:ring-4 focus:ring-indigo-500/20">
                            ...
                            <SelectContent>
                                {courses.map((course) => (
                                    ...
                                    >
                                        <div className="flex w-full min-w-[300px] items-center justify-between gap-4">
                                            <div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span
                                                    className={`rounded px-2 py-0.5 text-xs font-bold ${getAttendanceColor(course.average_attendance_rate)}`}
                                                >
                                                    {
                        ...
                        {selectedCourse && (
                            <motion.div
                                ...
                                className="grid grid-cols-4 gap-3 border-t border-neutral-200/50 pt-4 dark:border-neutral-800"
                            >
                                ...
                                <div className="rounded-xl bg-emerald-50 p-3 text-center dark:bg-emerald-900/20">
                                    <p className="text-2xl font-bold text-emerald-600">
                                        {selectedCourse.completed_sessions}/
                                ...
                                <div className="rounded-xl bg-red-50 p-3 text-center dark:bg-red-900/20">
                                    <p className="text-2xl font-bold text-red-600">
                                        {selectedCourse.at_risk_students}
                                    </p>
                                    <p className="text-xs text-neutral-500">
                                        At-Risk
                                    </p>
                ...
                >
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className={`rounded-lg px-3 py-1.5 text-sm font-medium transition-colors ${chartType === 'line' ? 'bg-indigo-500 text-white' : 'bg-neutral-100 dark:bg-neutral-800'}`}
                            >
                                Line
                            </button>
                            <button
                                onClick={() => setChartType('bar')}
                                className={`rounded-lg px-3 py-1.5 text-sm font-medium transition-colors ${chartType === 'bar' ? 'bg-indigo-500 text-white' : 'bg-neutral-100 dark:bg-neutral-800'}`}
                            >
                                Bar
                            </button>
                        </div>
                    ...
                    {selectedCourse ? (
                        <div className="h-80 w-full">
                            <ResponsiveContainer width="100%" height="100%">
                                {chartType === 'line' ? (
                                    <ReLineChart
                                        data={
                                            selectedCourse.attendance_by_session
                                        }
                                    >
                                        <CartesianGrid
                                            strokeDasharray="3 3"
                        ...
                        <div className="flex h-80 items-center justify-center text-neutral-400">
                            Pilih mata kuliah untuk melihat data
                        </div>
                    )}
                </motion.div>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    >
                        ...
                        {selectedCourse ? (
                            <div className="space-y-4">
                                {Object.entries(
                                    selectedCourse.grade_distribution,
                                ).map(([grade, count]) => (
                                    <div
                                        key={grade}
                                    ...
                                    >
                                        <motion.span
                                            ...
                                            className={`h-10 w-10 rounded-xl ${getGradeColor(grade)} flex items-center justify-center text-lg font-bold text-white shadow-lg`}
                                        >
                                            {grade}
                                        </motion.span>
                                        <div className="flex-1">
                                            ...
                                            <div className="h-3 overflow-hidden rounded-full bg-neutral-200 dark:bg-neutral-800">
                                                <motion.div
                                                    initial={{ width: 0 }}
                                                    animate={{
                                                        width: `${selectedCourse.total_students > 0 ? (count / selectedCourse.total_students) * 100 : 0}%`,
                                                    }}
                                                    transition={{
                                                        duration: 1,
                                                        delay: 0.3,
                        ...
                        {selectedCourse ? (
                            <div className="space-y-6">
                                        ...
                                        {selectedCourse.top_performers
                                            ...
                                            .map((s, i) => (
                                                <motion.div
                                                    ...
                                                    className="flex items-center justify-between rounded-xl border border-emerald-200 bg-emerald-50 p-2 dark:border-emerald-800 dark:bg-emerald-900/20"
                                                >
                                                    <div className="flex items-center gap-3">
                                                        <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-emerald-500 text-xs font-bold text-white">
                                                            {i + 1}
                                                        </div>
                                                        <div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        {selectedCourse.bottom_performers
                                            .slice(0, 3)
                                            .map((s, i) => (
                                                <motion.div
                                                    key={s.mahasiswa_id}
                                                    ...
                                                    className="flex items-center justify-between rounded-xl border border-red-200 bg-red-50 p-2 dark:border-red-800 dark:bg-red-900/20"
                                                >
                                                    <div className="flex items-center gap-3">
                                                        <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-red-500 text-xs font-bold text-white">
                                                            {i + 1}
                                                        </div>
                                                        <div>
                                                            <p className="text-sm font-bold">
                ...
                {showCompareModal && (
                    ...
                    >
                        <motion.div
                            ...
                            className="flex max-h-[90vh] w-full max-w-5xl flex-col overflow-hidden rounded-3xl border border-white/20 bg-white shadow-2xl dark:bg-neutral-950"
                        >
                            <div className="relative shrink-0 overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 p-6 text-white">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-white/80">
                                                Analisis komparatif antar mata
                                                kuliah
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="flex-1 space-y-6 overflow-y-auto p-6">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <Select
                                            value={compareClass1}
                                            onValueChange={setCompareClass1}
                                        >
                                            <SelectTrigger>
                                ...
                                {compareClass1 && compareClass2 && (
                                    <div className="h-[400px] rounded-2xl border border-neutral-200/50 bg-neutral-50/50 p-6 dark:border-neutral-800 dark:bg-neutral-900/50">
                                        <h4 className="mb-4 font-bold">
                                            Perbandingan Kehadiran Sesi
                                        </h4>
                                        <ResponsiveContainer
                                            width="100%"
                                            height="100%"
                ...
                {showAIInsights && selectedCourse && (
                    ...
                    >
                        <motion.div
                            ...
                            onClick={(e) => e.stopPropagation()}
                            className="flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-3xl border border-white/20 bg-white shadow-2xl dark:bg-neutral-950"
                        >
                            <div className="relative shrink-0 overflow-hidden bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-500 p-6 text-white">
                                <div className="absolute -top-10 -right-10 h-40 w-40 rounded-full bg-white/10 blur-3xl" />
                                <div className="relative flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/30 bg-white/20 backdrop-blur-xl">
                            ...
                            <div className="flex-1 space-y-4 overflow-y-auto p-6">
                                <motion.div
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    className="flex gap-4 rounded-2xl border border-blue-200/50 bg-blue-50/50 p-5 dark:border-blue-800/50 dark:bg-blue-900/20"
                                >
                                    <div className="h-fit rounded-xl bg-blue-500 p-3 text-white">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-blue-700 dark:text-blue-400">
                                            ...
                                            dengan perubahan{' '}
                                            {Math.abs(
                                                selectedCourse.trend_percentage,
                                            )}
                                            %.{' '}
                                            {selectedCourse.trend === 'down' &&
                                                'Perlu intervensi agar tidak semakin turun.'}
                                        </p>
                                    </div>
                                </motion.div>
                                {selectedCourse.at_risk_students > 0 && (
                                    <motion.div
                                        initial={{ opacity: 0, y: 20 }}
                                        animate={{ opacity: 1, y: 0 }}
                                        transition={{ delay: 0.2 }}
                                        className="flex gap-4 rounded-2xl border border-red-200/50 bg-red-50/50 p-5 dark:border-red-800/50 dark:bg-red-900/20"
                                    >
                                        <div className="h-fit rounded-xl bg-red-500 p-3 text-white">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-red-700 dark:text-red-400">
                                                ...
                                                mahasiswa dengan kehadiran di
                                                bawah 75%. Segera lakukan
                                ...
                                <motion.div
                                    ...
                                    animate={{ opacity: 1, y: 0 }}
                                    transition={{ delay: 0.2 }}
                                    className="flex gap-4 rounded-2xl border border-purple-200/50 bg-purple-50/50 p-5 dark:border-purple-800/50 dark:bg-purple-900/20"
                                >
                                    <div className="h-fit rounded-xl bg-purple-500 p-3 text-white">
                                    ...
                                    <div>
                                        ...
                                        <ul className="mt-2 space-y-2 text-sm text-purple-700 dark:text-purple-400">
                                            ...
                                            <li className="flex gap-2">
                                                <CheckCircle className="mt-0.5 h-4 w-4" />
                                                <span>
                                                    Evaluasi materi pertemuan
                                                    dengan kehadiran terendah.
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        >
                            ...
                            <div className="space-y-3 p-6">
                                <motion.button
                                    ...
                                    className="flex w-full items-center gap-4 rounded-2xl border border-neutral-200/50 bg-neutral-50/50 p-4 transition-colors hover:bg-emerald-50 disabled:opacity-50 dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:bg-emerald-900/20"
                                >
                                ...
                                <motion.button
                                    ...
                                    disabled={isExporting}
                                    className="flex w-full items-center gap-4 rounded-2xl border border-neutral-200/50 bg-neutral-50/50 p-4 transition-colors hover:bg-red-50 disabled:opacity-50 dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:bg-red-900/20"
                                >
                                ...
                                <motion.button
                                    ...
                                    disabled={isExporting}
                                    className="flex w-full items-center gap-4 rounded-2xl border border-neutral-200/50 bg-neutral-50/50 p-4 transition-colors hover:bg-blue-50 disabled:opacity-50 dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:bg-blue-900/20"
                                >
                                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blue-400 to-indigo-600 text-white shadow-lg">
