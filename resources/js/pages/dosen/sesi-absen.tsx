                    ...
                    <div className="relative">
                        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-6">
                            <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-6 text-center sm:text-left w-full lg:w-auto">
                                ...
                                >
                                    <img src={SesiAbsenIcon} alt="Sesi Absen" className="absolute inset-0 h-full w-full object-contain drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)]" />
                                </motion.div>
                                <div className="flex-1 mt-1 sm:mt-0">
                                    ...
                                    <motion.p className="mt-2 text-indigo-100 text-sm sm:text-base leading-relaxed"
                                        ...
                                        Kelola sesi absensi mata kuliah Anda dengan mudah
                                    </motion.p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col items-center lg:items-end gap-3 w-full lg:w-auto mt-2 lg:mt-0">
                                ...
                                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }}
                                    ...
                                    {([
                                        { icon: Plus, label: 'Buat Sesi', href: '/dosen/sesi-absen/create' },
                                        { icon: FileText, label: 'Template', href: '/dosen/session-templates' },
                                        { icon: Download, label: 'Laporan', href: '/dosen/rekapan' },
                                    ] as { icon: any; label: string; href: string }[]).map(btn => (
                ...
                >
                    {summaryCards.map((card, i) => {
                        const colorMap: Record<string, any> = {
                            'bg-violet-500': { from: 'from-violet-400', to: 'to-purple-600', gradientBg: 'from-violet-500/5 to-purple-500/5 dark:from-violet-500/10 dark:to-purple-500/10', hoverShadow: 'hover:shadow-violet-500/10' },
                            ...
                            'bg-blue-500': { from: 'from-blue-400', to: 'to-cyan-600', gradientBg: 'from-blue-500/5 to-cyan-500/5 dark:from-blue-500/10 dark:to-cyan-500/10', hoverShadow: 'hover:shadow-blue-500/10' },
                        };
                        const cc = colorMap[card.glow] || colorMap['bg-violet-500'];
                        return (
                            <motion.div
                                key={card.key}
                                variants={{
