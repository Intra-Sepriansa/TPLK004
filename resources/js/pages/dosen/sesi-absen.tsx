...
export default function DosenSesiAbsen({
    dosen,
    sessions,
    courses,
    stats,
    ...
    const handleActivate = (id: number) =>
        router.patch(`/dosen/sessions/${id}/activate`);
    const handleClose = (id: number) =>
        router.patch(`/dosen/sessions/${id}/close`);
    ...
    const filteredSessions = useMemo(() => {
        return sessions.filter((s) => {
            ...
            const matchCourse =
                filterCourse === 'all' || String(s.course_id) === filterCourse;
            const matchStatus =
                filterStatus === 'all' ||
    ...
    const summaryCards = [
        {
            ...
            sub: `${stats.activeSessions} sesi aktif`,
    ...
    const tabs = [
        { key: 'all' as const, label: 'Semua Sesi', count: sessions.length },
        {
            key: 'active' as const,
            label: 'Sesi Aktif',
            count: sessions.filter((s) => s.is_active).length,
        },
        {
            ...
            <AnimatePresence>
                {showToast && (flash?.success || flash?.error) && (
                    <motion.div
                        ...
                        className="fixed top-20 right-4 z-50 flex w-full max-w-sm shadow-2xl md:right-8"
                    >
                        <div
                            className={cn(
                                'relative w-full overflow-hidden rounded-2xl border p-4 shadow-2xl backdrop-blur-3xl',
                                flash.success
                        ...
                        >
                            ...
                            <div
                                className={cn(
                                    'absolute -top-10 -right-10 h-32 w-32 rounded-full opacity-50 blur-3xl',
                                    flash.success
                                        ? 'bg-emerald-500'
                                        : 'bg-rose-500',
                                )}
            ...
            >
                ...
                >
                    {summaryCards.map((card, i) => {
                        ...
                        const cc =
                            colorMap[card.glow] || colorMap['bg-violet-500'];
                        return (
                            <motion.div
                                key={card.key}
                                variants={{
                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="border-b border-white/10 bg-gradient-to-r from-indigo-500/5 to-purple-500/5">
                                        ...
                                        <th className="px-4 py-4 text-left font-semibold text-neutral-700 dark:text-neutral-300">
                                            Pertemuan
                                        </th>
                                        <th className="px-4 py-4 text-left font-semibold text-neutral-700 dark:text-neutral-300">
                                            Waktu
                                        ...
                                        {filteredSessions.length === 0 ? (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <AlertCircle className="mx-auto mb-3 h-12 w-12 text-neutral-300 dark:text-neutral-700" />
                                                ...
                                                (session, i) => {
                                                    ...
                                                    return (
                                                        <motion.tr
                                                            ...
                                                            className="group border-b border-white/5 transition-colors hover:bg-white/30 dark:hover:bg-white/5"
                                                        >
                                                            <td className="px-6 py-4">
                                                                <div>
                                                                    ...
                                                                    <div className="mt-1 flex items-center gap-2">
                                                                        ...
                                                                        <span className="rounded bg-indigo-100 px-1.5 py-0.5 text-[10px] font-medium text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400">
                                                                            {
                                                                                session.course_sks
                                                                            }{' '}
                                                                            SKS
                                                            ...
                                                            <td className="px-4 py-4">
                                                                <div className="inline-flex items-center gap-1.5 rounded-full border border-indigo-200/50 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 px-3 py-1 dark:border-indigo-800/50">
                                                            ...
                                                            <td className="px-4 py-4">
                                                                <div className="flex flex-col items-center gap-1">
                                                                    ...
                                                                    {total >
                                                                        0 && (
                                                                        <div className="flex h-1.5 w-full max-w-[120px] overflow-hidden rounded-full bg-neutral-200 dark:bg-neutral-700">
                                                                            <div
                                                            ...
                                                            <td className="px-4 py-4 text-center">
                                                                {session.is_active ? (
                                                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-700 shadow-sm dark:bg-emerald-900/30 dark:text-emerald-400">
                                            ...
                                            <div className="p-5">
                                                <div className="mb-3 flex items-start justify-between">
                                                    ...
                                                    {session.is_active ? (
                                                        ...
                                                        <span className="rounded-full bg-neutral-100 px-2 py-1 text-[10px] font-bold text-neutral-500 dark:bg-neutral-800 dark:text-neutral-400">
                                                            Nonaktif
                                                        </span>
                                                    )}
                                                </div>
                                                ...
                                                {session.title && (
                                                    <p className="mb-3 line-clamp-1 text-xs text-neutral-500 dark:text-neutral-400">
                                                        {session.title}
                                                    </p>
                                                )}

                                                <div className="mb-4 flex items-center gap-4 text-xs text-neutral-500 dark:text-neutral-400">
                                                ...
                                                {/* Progress Bar */}
                                                {total > 0 && (
                                                    <div className="mt-2 flex h-1.5 overflow-hidden rounded-full bg-neutral-200 dark:bg-neutral-700">
                                                        <div
                                                            className="h-full rounded-l-full bg-emerald-500"
                                                            style={{
                                                                width: `${(session.present_count / total) * 100}%`,
                                                            }}
                                                        />
                                                        <div
                                                            className="h-full bg-amber-500"
                                                            style={{
                                                                width: `${(session.late_count / total) * 100}%`,
                                                            }}
                                                        />
                                                        <div
                                                            className="h-full rounded-r-full bg-rose-500"
                                                            style={{
                                                                width: `${(session.rejected_count / total) * 100}%`,
                                                            }}
                                                        />
                                                    </div>
                                                )}
                                                ...
                                                <div className="mt-4 flex items-center gap-2 border-t border-white/10 pt-3">
                                                    <motion.button
                                                        ...
                                                        className="flex-1 rounded-lg bg-indigo-500/10 py-1.5 text-xs font-semibold text-indigo-600 transition-colors hover:bg-indigo-500/20 dark:text-indigo-400"
                                                    >
                                                        Detail
                                                    </motion.button>
                                                    {session.is_active ? (
                                                        <motion.button
                                                            ...
                                                            className="flex-1 rounded-lg bg-rose-500/10 py-1.5 text-xs font-semibold text-rose-600 transition-colors hover:bg-rose-500/20 dark:text-rose-400"
                                                        >
                                                            Nonaktifkan
                                                        </motion.button>
                                                    ) : (
                                                        <motion.button
                                                            ...
                                                            className="flex-1 rounded-lg bg-emerald-500/10 py-1.5 text-xs font-semibold text-emerald-600 transition-colors hover:bg-emerald-500/20 dark:text-emerald-400"
                                                        >
                                                            Aktifkan
                                                        </motion.button>
                                                    )}
                ...
                <AnimatePresence>
                    {showCreateModal && (
                        <>
                            ...
                            >
                                <motion.div
                                    className="pointer-events-auto max-h-[90vh] w-full max-w-2xl overflow-hidden overflow-y-auto rounded-3xl bg-white shadow-2xl dark:bg-neutral-900"
                                ...
                                >
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                >
                                                    <img
                                                        src={SesiBaruIcon}
                                                        alt="Sesi Baru"
                                                        className="pointer-events-none h-20 w-20 object-contain drop-shadow-xl"
                                                    />
                                                </motion.div>
                                                <div>
                                    ...
                                    >
                                        ...
                                        >
                                            <label className="mb-3 flex items-center gap-2 text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                                            ...
                                            <select
                                                ...
                                                className="w-full rounded-xl border-2 border-neutral-200 bg-white px-4 py-3 text-sm shadow-sm transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white"
                                                required
                                            >
                                                <option value="">
                                                    Pilih Mata Kuliah
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    className="w-full rounded-xl border-2 border-neutral-200 bg-white px-4 py-3 text-sm shadow-sm transition-all focus:border-violet-500 focus:ring-4 focus:ring-violet-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white"
                                                    required
                                                />
                                            </motion.div>
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    className="w-full rounded-xl border-2 border-neutral-200 bg-white px-4 py-3 text-sm shadow-sm transition-all focus:border-amber-500 focus:ring-4 focus:ring-amber-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white"
                                                />
                                            </motion.div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    className="w-full rounded-xl border-2 border-neutral-200 bg-white px-4 py-3 text-sm shadow-sm transition-all focus:border-green-500 focus:ring-4 focus:ring-green-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white"
                                                    required
                                                />
                                            </motion.div>
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    className="w-full rounded-xl border-2 border-neutral-200 bg-white px-4 py-3 text-sm shadow-sm transition-all focus:border-rose-500 focus:ring-4 focus:ring-rose-500/20 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white"
                                                    required
                                                />
                                            </motion.div>
                                        </div>
                                        ...
                                        <motion.label
                                            ...
                                            animate={{ opacity: 1, y: 0 }}
                                            transition={{ delay: 0.4 }}
                                            className="flex cursor-pointer items-center gap-3 rounded-xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 to-teal-50 p-4 transition-all hover:border-emerald-300 dark:border-emerald-800 dark:from-emerald-900/20 dark:to-teal-900/20"
                                        ...
                                        >
                                            ...
                                            <div>
                                                <span className="flex items-center gap-2 text-sm font-semibold text-emerald-700 dark:text-emerald-300">
                                                    ...
                                                    Aktifkan langsung setelah
                                                    dibuat
                                                </span>
                                                <p className="mt-0.5 text-xs text-emerald-600 dark:text-emerald-400">
                                                    Sesi akan langsung aktif dan
                                        ...
                                        <AnimatePresence>
                                            {createForm.errors &&
                                                Object.keys(createForm.errors)
                                                    .length > 0 && (
                                                    <motion.div
                                                        className="rounded-xl border border-rose-200 bg-rose-50 p-4 text-sm text-rose-600 dark:border-rose-800 dark:bg-rose-900/20 dark:text-rose-400"
                                                        initial={{
                                                            opacity: 0,
                                                            height: 0,
                                                        }}
                                        ...
                                        <div className="flex justify-end gap-3 border-t border-neutral-200 pt-4 dark:border-neutral-700">
                                            <motion.button
                                                ...
                                                whileHover={{ scale: 1.02 }}
                                                whileTap={{ scale: 0.98 }}
                                                className="rounded-xl bg-neutral-100 px-6 py-3 text-sm font-semibold text-neutral-700 transition-colors hover:bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-700"
                                            >
                                                Batal
                                            </motion.button>
                                            <motion.button
                                                ...
                                                className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 px-6 py-3 text-sm font-semibold text-white shadow-lg disabled:cursor-not-allowed disabled:opacity-50"
                                            >
