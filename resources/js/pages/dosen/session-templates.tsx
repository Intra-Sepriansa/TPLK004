            ...
            >
                ...
                >
                    ...
                    <div className="relative">
                        <div className="flex flex-wrap items-center justify-between gap-6">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <h1 className="text-3xl font-bold text-white">Session Templates</h1>
                        ...
                        >
                            <motion.button whileHover={{ scale: 1.02, backgroundColor: 'rgba(255,255,255,0.25)' }} whileTap={{ scale: 0.98 }} onClick={openCreateModal} className="flex items-center gap-2 rounded-xl bg-white/20 px-5 py-2.5 text-sm font-semibold text-white backdrop-blur-md border border-white/20 shadow-lg">
                    ...
                    <motion.div variants={cardVariants} whileHover="hover" onHoverStart={() => setHoveredCard('total')} onHoverEnd={() => setHoveredCard(null)} className="group relative overflow-hidden rounded-3xl border border-white/20 bg-white/40 dark:bg-neutral-900/40 p-6 shadow-xl backdrop-blur-xl transition-all hover:shadow-violet-500/10 dark:border-white/5">
                        ...
                        <div className="relative flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="mt-1"><span className="text-2xl font-bold text-neutral-900 dark:text-white"><AnimatedCounter value={stats.total_templates} /></span></div>
                                <p className="text-xs text-neutral-400 mt-1">tersimpan</p>
                            </div>
                        </div>
                    </motion.div>

                    {/* Card 2: Template Aktif */}
                    <motion.div variants={cardVariants} whileHover="hover" onHoverStart={() => setHoveredCard('active')} onHoverEnd={() => setHoveredCard(null)} className="group relative overflow-hidden rounded-3xl border border-white/20 bg-white/40 dark:bg-neutral-900/40 p-6 shadow-xl backdrop-blur-xl transition-all hover:shadow-emerald-500/10 dark:border-white/5">
                        ...
                        <div className="relative flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="mt-1"><span className="text-2xl font-bold text-neutral-900 dark:text-white"><AnimatedCounter value={stats.active_templates} /></span></div>
                                <p className="text-xs text-neutral-400 mt-1">siap digunakan</p>
                            </div>
                        </div>
                    </motion.div>

                    {/* Card 3: Auto Activate */}
                    <motion.div variants={cardVariants} whileHover="hover" onHoverStart={() => setHoveredCard('auto')} onHoverEnd={() => setHoveredCard(null)} className="group relative overflow-hidden rounded-3xl border border-white/20 bg-white/40 dark:bg-neutral-900/40 p-6 shadow-xl backdrop-blur-xl transition-all hover:shadow-blue-500/10 dark:border-white/5">
                        ...
                        <div className="relative flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="mt-1"><span className="text-2xl font-bold text-neutral-900 dark:text-white"><AnimatedCounter value={stats.auto_activate_templates} /></span></div>
                                <p className="text-xs text-neutral-400 mt-1">otomatis aktif</p>
                            </div>
                        </div>
                    </motion.div>

                    {/* Card 4: Rata-rata Durasi */}
                    <motion.div variants={cardVariants} whileHover="hover" onHoverStart={() => setHoveredCard('duration')} onHoverEnd={() => setHoveredCard(null)} className="group relative overflow-hidden rounded-3xl border border-white/20 bg-white/40 dark:bg-neutral-900/40 p-6 shadow-xl backdrop-blur-xl transition-all hover:shadow-amber-500/10 dark:border-white/5">
                        ...
                        <div className="relative flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <span className="text-2xl font-bold text-neutral-900 dark:text-white"><AnimatedCounter value={stats.average_duration} /></span>
                                    <span className="text-sm text-neutral-500 ml-1">min</span>
                                </div>
                                <p className="text-xs text-neutral-400 mt-1">per sesi</p>
                            </div>
                        </div>
                    </motion.div>
                </motion.div>
