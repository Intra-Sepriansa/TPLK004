...
export default function SessionTemplates({
    ...
    const toggleDay = (day: number) => {
        ...
        setTemplateForm({
            ...templateForm,
            default_days: current.includes(day)
    ...
    const handleSubmitTemplate = (e: React.FormEvent) => {
        ...
        if (editingTemplate) {
            router.patch(
                `/dosen/session-templates/${editingTemplate.id}`,
                data,
                {
                    onSuccess: () => {
    ...
    const handleDuplicate = (template: Template) => {
        router.post(
            `/dosen/session-templates/${template.id}/duplicate`,
            {},
            {
    ...
    const handleToggleActive = (template: Template) => {
        router.patch(
            `/dosen/session-templates/${template.id}/toggle-active`,
            {},
            {
                onSuccess: () =>
                    toast.success(
    ...
    const handleGenerate = () => {
        ...
        generateForm.post(
            `/dosen/session-templates/${generateTemplate.id}/generate`,
            {
                onSuccess: () => {
        ...
        <DosenLayout dosen={dosen}>
            ...
            >
                    ...
                    <div className="relative">
                        <div className="flex flex-col items-center justify-between gap-6 lg:flex-row lg:items-start">
                            <div className="flex w-full flex-col items-center gap-5 text-center sm:flex-row sm:gap-6 sm:text-left lg:w-auto">
                                ...
                                >
                                    <img
                                        src={TemplateHeaderIcon}
                                        alt="Session Templates"
                                ...
                                <div className="mt-1 flex-1 sm:mt-0">
                                    ...
                                    >
                                        Buat template sesi otomatis yang dapat
                    ...
                    {(
                        [
                            ...
                            },
                            {
                                key: 'auto',
                                label: 'Auto-Activate',
                                value: stats.auto_activate_templates,
                                sub: 'otomatis aktif',
                                imgSrc: AutoActivateIcon,
                                from: 'from-blue-400',
                                to: 'to-cyan-600',
                                glow: 'bg-blue-500',
                        ...
                        <motion.div
                            ...
                            className={`group relative overflow-hidden rounded-2xl border border-white/20 bg-white/40 p-4 shadow-xl backdrop-blur-xl transition-all sm:rounded-3xl sm:p-6 dark:border-white/5 dark:bg-neutral-900/40 ${card.hoverShadow}`}
                        >
                            <div
                                className={`absolute inset-0 bg-gradient-to-br from-${card.glow.replace('bg-', '')}/5 to-transparent opacity-50 dark:opacity-100`}
                            />
                            <motion.div
                                className={`absolute -top-8 -right-8 h-28 w-28 rounded-full blur-3xl transition-all ${card.glow}`}
                                animate={{
                                    opacity:
                            ...
                            <div className="relative z-10 flex h-full flex-col items-center justify-between gap-3 sm:items-start">
                                <div className="flex flex-col items-center gap-2 text-center sm:flex-row sm:items-start sm:gap-4 sm:text-left">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1">
                                            <span className="text-xl font-bold text-neutral-900 sm:text-2xl dark:text-white">
                                                <AnimatedCounter
                                                    value={card.value}
                                                />
                                                {card.suffix}
                ...
                >
                    ...
                    {/* Quick Filters */}
                    <div className="flex flex-wrap gap-2 border-t border-neutral-200/50 pt-4 dark:border-neutral-800">
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            onClick={() => setSortBy('recent')}
                            className={`flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm font-medium transition-colors ${sortBy === 'recent' ? 'bg-indigo-500 text-white' : 'bg-neutral-100 text-neutral-600 dark:bg-neutral-800 dark:text-neutral-400'}`}
                        >
                        ...
                        <motion.button
                            ...
                            className={`flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm font-medium transition-colors ${sortBy === 'name' ? 'bg-indigo-500 text-white' : 'bg-neutral-100 text-neutral-600 dark:bg-neutral-800 dark:text-neutral-400'}`}
                        >
                        ...
                        {(searchQuery || filterStatus !== 'all') && (
                            <motion.button
                                ...
                                className="flex items-center gap-2 rounded-lg bg-neutral-100 px-3 py-1.5 text-sm font-medium text-neutral-600 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-700"
                            >
                ...
                {filteredTemplates.length === 0 ? (
                    <motion.div
                        variants={itemVariants}
                        className="rounded-3xl border border-white/20 bg-white/50 p-12 text-center shadow-lg backdrop-blur-xl dark:border-neutral-800 dark:bg-neutral-900/50"
                    >
                        <motion.div
                            animate={{ y: [0, -10, 0] }}
                            transition={{
                        ...
                        {!searchQuery && filterStatus === 'all' && (
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={openCreateModal}
                                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-3 font-semibold text-white shadow-lg shadow-indigo-500/30"
                            >
                                <Plus className="h-5 w-5" /> Buat Template
                                Pertama
                            </motion.button>
                        )}
                    </motion.div>
                        ...
                        <AnimatePresence mode="popLayout">
                            {filteredTemplates.map((template, idx) => (
                                <motion.div
                                    ...
                                    className={`group relative overflow-hidden rounded-3xl border border-white/20 bg-white/50 shadow-lg backdrop-blur-xl transition-all hover:shadow-xl dark:border-neutral-800 dark:bg-neutral-900/50 ${!template.is_active ? 'opacity-60' : ''}`}
                                >
                                    {/* Status badges */}
                                    <div className="absolute top-4 right-4 z-10 flex gap-2">
                                        {template.auto_activate && (
                                            <motion.div
                                                ...
                                                className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-500 text-white shadow-lg"
                                            >
                                                <Zap className="h-4 w-4" />
                                            </motion.div>
                                        )}
                                        <div
                                            className={`flex items-center gap-1 rounded-lg px-2.5 py-1 text-xs font-bold ${template.is_active ? 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30' : 'bg-neutral-100 text-neutral-500 dark:bg-neutral-800'}`}
                                        >
                                            <div
                                                className={`h-2 w-2 rounded-full ${template.is_active ? 'bg-emerald-500' : 'bg-neutral-400'}`}
                                            />
                                            {template.is_active
                                                ? 'Aktif'
                                                : 'Nonaktif'}
                                    ...
                                    <div className="px-6 pb-4">
                                        <div className="mb-4 grid grid-cols-2 gap-3">
                                            <div className="flex items-center gap-3 rounded-xl bg-orange-50 p-2.5 dark:bg-orange-900/20">
                                            ...
                                            <div className="flex items-center gap-3 rounded-xl bg-purple-50 p-2.5 dark:bg-purple-900/20">
                                                <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-purple-500 to-pink-600 text-white shadow-sm">
                                                ...
                                                <div className="flex flex-wrap gap-1">
                                                    {(
                                                        ...
                                                        <span
                                                            key={d}
                                                            className="rounded bg-purple-100 px-1.5 py-0.5 text-xs font-bold text-purple-700 dark:bg-purple-900/30 dark:text-purple-300"
                                                        >
                                                            {DAYS[d]?.slice(
                                                                0,
                                                                3,
                                        ...
                                        <div className="flex gap-2">
                                            <motion.button
                                                ...
                                                className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-4 py-2.5 text-sm font-medium text-white shadow-lg shadow-indigo-500/30"
                                            >
                                            ...
                                            <motion.button
                                                ...
                                                className="flex items-center justify-center rounded-xl bg-neutral-100 px-3 py-2.5 text-neutral-600 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-700"
                                            >
                                            ...
                                            <motion.button
                                                ...
                                                className="flex items-center justify-center rounded-xl bg-red-100 px-3 py-2.5 text-red-600 hover:bg-red-200 dark:bg-red-900/20 dark:hover:bg-red-900/30"
                                            >
                ...
                {showCreateModal && (
                    ...
                    >
                        <motion.div
                            ...
                            className="max-h-[90vh] w-full max-w-2xl overflow-hidden rounded-3xl border border-white/20 bg-white shadow-2xl dark:bg-neutral-950"
                        >
                            {/* Modal Header */}
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-white/80">
                                                Konfigurasi template untuk sesi
                                                absensi
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="max-h-[calc(90vh-180px)] overflow-y-auto p-6">
                                ...
                                >
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <Input
                                                    type="time"
                                                    value={
                                                        templateForm.default_start_time
                                                    }
                                                    onChange={(e) =>
                                                        setTemplateForm({
                                                            ...templateForm,
                                        ...
                                        <div className="grid grid-cols-4 gap-2">
                                            {DAYS.map((day, idx) => (
                                                <motion.button
                                                    ...
                                                    className={`rounded-xl px-3 py-2.5 text-sm font-medium transition-colors ${templateForm.default_days.includes(idx) ? 'bg-indigo-500 text-white shadow-lg shadow-indigo-500/30' : 'bg-neutral-100 text-neutral-600 dark:bg-neutral-800 dark:text-neutral-400'}`}
                                                >
                                                    {day}
                                                </motion.button>
                                            ))}
                                    ...
                                    {/* Auto Activate */}
                                    <div className="space-y-4 border-t border-neutral-200 pt-6 dark:border-neutral-800">
                                        <div className="flex items-center justify-between rounded-xl bg-neutral-50 p-4 dark:bg-neutral-900/50">
                                            <div>
                                                ...
                                                <p className="text-sm text-neutral-500">
                                                    Aktifkan sesi otomatis saat
                                                    digenerate
                                                </p>
                                            </div>
                                            <Switch
                                                checked={
                                                    templateForm.auto_activate
                                                }
                                                onCheckedChange={(v) =>
                                                    setTemplateForm({
                                                        ...templateForm,
                                    ...
                                    <div className="flex gap-3 border-t border-neutral-200 pt-6 dark:border-neutral-800">
                                        <motion.button
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            disabled={submitting}
                                            className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-3 font-semibold text-white shadow-lg shadow-indigo-500/30 disabled:opacity-50"
                                        >
                                            {submitting ? (
                                                <>
                                        ...
                                        <motion.button
                                            ...
                                            className="rounded-xl bg-neutral-100 px-6 py-3 font-semibold text-neutral-600 dark:bg-neutral-800 dark:text-neutral-400"
                                        >
                                            Batal
                                        </motion.button>
                                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="space-y-4 p-6">
                                {/* Template Preview */}
                                <div className="rounded-2xl border border-emerald-200/50 bg-emerald-50/50 p-4 dark:border-emerald-800/50 dark:bg-emerald-900/20">
                                    <div className="flex items-center gap-3">
                                        <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-100 text-emerald-600 dark:bg-emerald-900/50">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-neutral-500">
                                                {
                                                    generateTemplate.default_start_time
                                                }{' '}
                                                -{' '}
                                                {
                                                    generateTemplate.default_end_time
                                                }{' '}
                                                (
                                                {
                                                    generateTemplate.duration_minutes
                                                }{' '}
                                                menit)
                                            </p>
                                        </div>
                                ...
                                <div className="flex gap-3 pt-4">
                                    <motion.button
                                        ...
                                        className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 px-6 py-3 font-semibold text-white shadow-lg shadow-emerald-500/30 disabled:opacity-50"
                                    >
                ...
                {showDeleteConfirm && deleteTarget && (
                    ...
                    >
                        <motion.div
                            ...
                            onClick={(e) => e.stopPropagation()}
                            className="w-full max-w-sm overflow-hidden rounded-3xl border border-white/40 bg-[#050709] text-white shadow-[0_25px_70px_rgba(0,0,0,0.75)]"
                        >
                            <div className="relative overflow-hidden bg-gradient-to-br from-neutral-950 via-black to-neutral-900 p-6 text-white">
                                ...
                                <div className="relative flex items-center gap-3">
                                    <motion.div
                                        ...
                                        className="flex h-16 w-16 items-center justify-center rounded-2xl border border-red-400/30 bg-red-500/15 backdrop-blur-xl"
                                    >
                                        <img
                                            src={DeleteIconImage}
                                            alt="Hapus"
                            ...
                            <div className="space-y-4 p-6">
                                <p className="text-sm text-neutral-300">
                                    ...
                                    ? Template yang sudah dihapus tidak dapat
                                    dikembalikan.
                                </p>
                                <div className="rounded-2xl border border-red-400/30 bg-red-500/12 px-4 py-3">
                                    <p className="text-[10px] font-semibold tracking-[0.22em] text-red-200 uppercase">
                                        Konfirmasi Aksi
                                    </p>
                                    <p className="mt-1 text-sm leading-relaxed text-red-100/90">
                                        Aksi ini permanen. Data yang dihapus
                                ...
                                <div className="flex gap-3">
                                    <motion.button
                                        ...
                                        className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-rose-600 via-red-600 to-rose-700 px-6 py-3 font-semibold text-white shadow-[0_14px_30px_rgba(225,29,72,0.35)] transition-all hover:from-rose-500 hover:via-red-500 hover:to-rose-600"
                                    >
